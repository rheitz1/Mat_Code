...
minimize_routine = 'X2'; %MLE or X2? %NOTE: X2 seems more sensitive than MLE to starting values
...
show_minimization = 0; %do you want to view the minimization (takes longer)?
...
if plotFlag
    ...
    text(100,.85,['v = ' mat2str(round(v(1)*100)/100)],'fontweight','bold','fontsize',16)
    text(100,.80,['s = ' mat2str(round(s(1)*100)/100)],'fontweight','bold','fontsize',16)
    text(100,.75,['T0 = ' mat2str(round(T0(1)*100)/100)],'fontweight','bold','fontsize',16)
    title('ACCURATE')
    box off
    ...
    if ~include_med
        ...
        text(100,.85,['v = ' mat2str(round(v(2)*100)/100)],'fontweight','bold','fontsize',16)
        text(100,.80,['s = ' mat2str(round(s(2)*100)/100)],'fontweight','bold','fontsize',16)
        text(100,.75,['T0 = ' mat2str(round(T0(2)*100)/100)],'fontweight','bold','fontsize',16)
    ...
    elseif include_med
        ...
        text(100,.85,['v = ' mat2str(round(v(3)*100)/100)],'fontweight','bold','fontsize',16)
        text(100,.80,['s = ' mat2str(round(s(3)*100)/100)],'fontweight','bold','fontsize',16)
        text(100,.75,['T0 = ' mat2str(round(T0(3)*100)/100)],'fontweight','bold','fontsize',16)
        title('FAST','fontsize',16,'fontweight','bold')
        box off
        set(gca,'xminortick','on')
