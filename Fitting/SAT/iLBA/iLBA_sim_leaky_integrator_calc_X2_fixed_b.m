function X2 = iLBA_sim_leaky_integrator_calc_X2_fixed_b(params,ntiles,trls,obs_freq,seed,simBound)
plotFlag = 1;
...
%These are still normalized to 1.  Will plot them as defective CDFs below...
