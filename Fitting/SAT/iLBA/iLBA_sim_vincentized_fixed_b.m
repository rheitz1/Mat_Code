...
function [solution minval] = iLBA_sim_vincentized_fixed_b(file,PopN,GenLim,nTrials,seed,sd_rate,start_param,minimizer)
...
if nargin < 8; minimizer = 'simplex'; end
...
if minimize
    ...
    if strmatch(minimizer,'simplex')
        ...
        [solution minval exitflag output] = fminsearchbnd(@(param) iLBA_sim_leaky_integrator_calc_X2_fixed_b(param,ntiles,trls,obs_freq,seed,simBound),param,lower,upper,options);
    ...
    elseif strmatch(minimizer,'ga')
        ...
        [solution minval exitflag output] = ga(@(param) iLBA_sim_leaky_integrator_calc_X2_fixed_b(param,ntiles,trls,obs_freq,seed,simBound),numel(param),[],[],[],[],lower,upper,[],options);
    ...
    elseif strmatch(minimizer,'sa')
        ...
        [solution minval exitflag output] = simulannealbnd(@(param) iLBA_sim_leaky_integrator_calc_X2_fixed_b(param,ntiles,trls,obs_freq,seed,simBound),param,lower,upper,options);
