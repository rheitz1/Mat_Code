function X2 = iLBA_sim_leaky_integrator_calc_X2_fixed_b_Neural_Input(params,ntiles,trls,obs_freq,seed)
plotFlag = 1;
...
allwf_targ = evalin('caller','allwf_targ');
...
[b T0.slow T0.med T0.fast leakage] = disperse(params);
...
% END INTEGRATION
    ...
    actFun.slow.correct = nanmean(allwf_targ.in.slow_correct_made_dead(Samp1,:));
    actFun.med.correct = nanmean(allwf_targ.in.med_correct(Samp2,:));
    actFun.fast.correct = nanmean(allwf_targ.in.fast_correct_made_dead_withCleared(Samp3,:));
    actFun.slow.errors = nanmean(allwf_targ.out.slow_errors_made_dead(Samp4,:));
    actFun.med.errors = nanmean(allwf_targ.out.med_errors(Samp5,:));
    actFun.fast.errors = nanmean(allwf_targ.out.fast_errors_made_dead_withCleared(Samp6,:));
