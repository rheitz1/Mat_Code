...
function [solution minval] = iLBA_sim_vincentized_fixed_T0(file,PopN,GenLim,nTrials,seed,start_param,minimizer)
...
outdir = '/volumes/Dump/Analyses/SAT/Models/iLBA_X2/fixed_T0/';
%outdir = '//scratch/heitzrp/Output/iLBA/fixed_T0/';
...
if nargin < 6
    ...
    [A.slow A.med A.fast b.slow b.med b.fast v.slow v.med v.fast T0 leakage sd_rate] = disperse(start_param);
...
param = [A.slow A.med A.fast b.slow b.med b.fast v.slow v.med v.fast T0 leakage sd_rate];
...
if minimize
    ...
    if strmatch(minimizer,'simplex')
        ...
        %[solution minval exitflag output] = fminsearch(@(param) iLBA_sim_leaky_integrator_calc_X2_fixed_T0(param,ntiles,trls,obs_freq,seed,simBound),param,options);
        [solution minval exitflag output] = fminsearchbnd(@(param) iLBA_sim_leaky_integrator_calc_X2_fixed_T0(param,ntiles,trls,obs_freq,seed,simBound),param,lower,upper,options);
    ...
    elseif strmatch(minimizer,'ga')
        ...
        [solution minval exitflag output] = ga(@(param) iLBA_sim_leaky_integrator_calc_X2_fixed_T0(param,ntiles,trls,obs_freq,seed,simBound),numel(param),[],[],[],[],lower,upper,[],options);
...
if plotFlag
    ...
    [A.slow A.med A.fast b.slow b.med b.fast v.slow v.med v.fast T0 leakage sd_rate] = disperse(solution);
    b.slow = b.slow * 100;
    b.med = b.med * 100;
    b.fast = b.fast * 100;
