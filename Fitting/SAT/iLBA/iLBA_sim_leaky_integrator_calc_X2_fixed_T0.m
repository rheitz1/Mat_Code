function X2 = iLBA_sim_leaky_integrator_calc_X2_fixed_T0(params,ntiles,trls,obs_freq,seed,simBound)
plotFlag = 1;
...
[A.slow A.med A.fast b.slow b.med b.fast v.slow v.med v.fast T0 leakage sd_rate] = disperse(params);
b.slow = b.slow * 100;
b.med = b.med * 100;
b.fast = b.fast * 100;
