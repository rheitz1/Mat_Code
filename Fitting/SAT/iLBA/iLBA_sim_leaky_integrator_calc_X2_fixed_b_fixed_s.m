function X2 = iLBA_sim_leaky_integrator_calc_X2_fixed_b_fixed_s(params,ntiles,trls,obs_freq,seed)
plotFlag = 1;
...
% 
% rt.slow(find(rt.slow+T0.slow < 500)) = NaN;
% rt.fast(find(rt.fast+T0.fast > 350)) = NaN;
