function X2 = iLBA_sim_leaky_integrator_calc_X2_fixed_v(params,ntiles,trls,obs_freq,seed,simBound)
plotFlag = 0;
...
[A.slow A.med A.fast b.slow b.med b.fast v T0.slow T0.med T0.fast leakage sd_rate] = disperse(params);
b.slow = b.slow * 100;
b.med = b.med * 100;
b.fast = b.fast * 100;
