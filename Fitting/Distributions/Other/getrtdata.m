...
if strcmp(exp,'SER')
    [sinit,tp_yn,ss,sub_resp,err,mess,rt] = textread('Serial_Trunc.txt','%s %d %d %s %d %s %d',41000);
elseif strcmp(exp,'FEAT')
    [sinit,tp_yn,ss,sub_resp,err,mess,rt] = textread('Feature_Trunc.txt','%s %d %d %s %d %s %d',41000);
elseif strcmp(exp,'CONJ')
    [sinit,tp_yn,ss,sub_resp,err,mess,rt] = textread('Conj_Trunc.txt','%s %d %d %s %d %s %d',41000);
end;
