...
F_correct1(:,1) = linearballisticCDF(SRT_correct1,A,b,v1,s);
F_correct2(:,1) = linearballisticCDF(SRT_correct2,A,b,v2,s);
F_correct3(:,1) = linearballisticCDF(SRT_correct3,A,b,v3,s);

F_err1(:,1) = linearballisticCDF(SRT_err1,A,b,1-v1,s);
F_err2(:,1) = linearballisticCDF(SRT_err2,A,b,1-v2,s);
F_err3(:,1) = linearballisticCDF(SRT_err3,A,b,1-v3,s);

f_correct1(:,1) = linearballisticPDF(SRT_correct1,A,b,v1,s);
f_correct2(:,1) = linearballisticPDF(SRT_correct2,A,b,v2,s);
f_correct3(:,1) = linearballisticPDF(SRT_correct3,A,b,v3,s);

f_err1(:,1) = linearballisticPDF(SRT_err1,A,b,1-v1,s);
f_err2(:,1) = linearballisticPDF(SRT_err2,A,b,1-v2,s);
f_err3(:,1) = linearballisticPDF(SRT_err3,A,b,1-v3,s);
...
LL_correct1 = -sum(log(linearballisticPDF(SRT_correct1,A,b,v1_correct,s)));
LL_correct2 = -sum(log(linearballisticPDF(SRT_correct2,A,b,v2_correct,s)));
LL_correct3 = -sum(log(linearballisticPDF(SRT_correct3,A,b,v3_correct,s)));


LL_err1 = -sum(log(linearballisticPDF(SRT_err1,A,b,v1_err,s)));
LL_err2 = -sum(log(linearballisticPDF(SRT_err2,A,b,v2_err,s)));
LL_err3 = -sum(log(linearballisticPDF(SRT_err3,A,b,v3_err,s)));
