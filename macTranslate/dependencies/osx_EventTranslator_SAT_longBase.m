function [TrialStart_,Strobe_Times] = osx_EventTranslator_SAT_longBase(file_path,filename,TrialStart_TimeStamps,outfile,target_on_Evt2,fix_on_Evt2,Strobe_Times,Strobe_Values)
