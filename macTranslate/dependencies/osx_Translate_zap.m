...
Zap_times = find(diff(AD45) > 5);

for z = 1:length(Zap_times)
    X(z,1:1001) = EyeX_(Zap_times(z)-200:Zap_times(z)+800);
    Y(z,1:1001) = EyeY_(Zap_times(z)-200:Zap_times(z)+800);
    Z(z,1:1001) = AD45(Zap_times(z)-200:Zap_times(z)+800); %uStim GATE raw input
end
