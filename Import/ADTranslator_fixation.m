...
for ich = 0:64
    if ( evcounts(300+ich) > 0 )
        ...
        %          disp('doing the 250Hz filter... please wait')
        %              [temp] = lowerRate (temp);
        % %         AD01=temp;
...
for curAD = 1:length (ADCHs)
    ...
    for curCHUNK = 0:multifilenameNo
        ...
        for curTrl = curCHUNK*maxTrialNo+1:curCHUNK*maxTrialNo+NEXTSTEP
                ...
                startcount=TrialStart_(curTrl)-450;    endcount =TrialStart_(curTrl);
...
% 
% 
%                 if (endcount-startcount)>2500%10000
%                     endcount=TrialStart_(curTrl)+2500;%10000;
%                 end;
