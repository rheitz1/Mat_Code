...
function[] = Translate_SAT_behavior_only(file_path,filename)
...
%GET EVENTS
[TrialStart_] = EventTranslator_SAT_longBase(file_path,filename,TrialStart_TimeStamps,outfile,target_on_Evt2,fix_on_Evt2,Times_to_pass,Events_to_pass);

%======================
% CUT UP AD CHANNELS
ADTranslator_behavior_only(file_path,filename,TrialStart_,Strobe_Times,outfile)


%======================
% CUT UP SPIKE CHANNELS
SpikeTranslator_longBase(file_path,filename,TrialStart_,Strobe_Times,outfile)
