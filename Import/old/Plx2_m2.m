function [] = Plx2_m2 (file_path,filename)
...
%presently: 060513
%filepath='D:\PlexonData\FecImp\PlexonData\';
%filename='Fecszz050406a.plx';
...
elseif nargin == 2
        ofile_ = strcat('_m.');        
        fileID= filename(7:end-4);
        outfile=strcat(filename(1:6), ofile_, fileID ,'.mat');
end
...
PlxAD2_mAD2 (file_path, filename, TrialStart_ ,TimeStamps_Strobe_Events,outfile)
