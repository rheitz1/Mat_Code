...
for i = 1:14
    figure(i)
    s = sprintf('print -dtiffnocompression mgfFig%d.tif', i)
    eval(s)
end
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% Part 2. The MGF of a sums & differences of RVs
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% The mfg of a variety of RVs formed by taking the difference of two RVs
...
% Difference Poissons. Intensity scales the expectations symmetrically for
% opposing sources of evidence
theta = [-5:dtheta:5]';     % the axis has to be symmetric about 0.
u1list = [10:.5:14]';
u2list = [10:-.5:6]';
% These are fun to compare. Suppose the "antineuron" does not attenuate.
% u1list = [10:1:18]';
% u2list = repmat(10,size(u1list));
...
theta = [-5:dtheta:5]';     % the axis has to be symmetric about 0.
u1list = [10:.5:14]'
nfact = 0   % Intensity affects the declining mean by nfact relative the the increasing mean. Use nfact=1 for symmetric changes. 
