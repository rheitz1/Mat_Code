...
function [] = pCOH_SPKLFP_Tune_NeurRF_isect_vamp_overlap_shuff_interp_vismove(file_name,sig1_name,sig2_name)
...
load(file_name,sig1_name,sig2_name, ...
    'MStim_','EyeX_','EyeY_','Target_','Errors_','newfile','Correct_','RFs','MFs','Hemi','SRT','TrialStart_')
...
%TO USE ONLY VIS-MOVE NEURONS, MAKE SURE THERE EXISTS A MOVEMENT FIELD

MF = MFs.(sig2_name);
if isempty(MF)
    disp('Skipping Vis cell')
    return
end
