...
function [integ_corr_in,integ_corr_out,integ_corr_in_fast,integ_corr_out_fast,integ_corr_in_slow,integ_corr_out_slow] = SDF_LFP_corr_overlap(file_name,sig1_name,sig2_name)
