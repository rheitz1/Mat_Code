...
cd /Volumes/Dump2/Coherence/SPK-LFP/Uber_Tune_NeuronRF_intersection_shuff_allTL_SameInterp_DiffNoInterp_VisMove/overlap/SameElectrode/
list1 = dir('Q*.mat');

cd /Volumes/Dump2/Coherence/SPK-LFP/Uber_Tune_NeuronRF_intersection_shuff_allTL_SameInterp_DiffNoInterp_VisMove/overlap/DifferentElectrode/
list2 = dir('Q*.mat');

path(path,'/Volumes/Dump2/Coherence/SPK-LFP/Uber_Tune_NeuronRF_intersection_shuff_allTL_SameInterp_DiffNoInterp_VisMove/overlap/SameElectrode/')
path(path,'/Volumes/Dump2/Coherence/SPK-LFP/Uber_Tune_NeuronRF_intersection_shuff_allTL_SameInterp_DiffNoInterp_VisMove/overlap/DifferentElectrode/');
