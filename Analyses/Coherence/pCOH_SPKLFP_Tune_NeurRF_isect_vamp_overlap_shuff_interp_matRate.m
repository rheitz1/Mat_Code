...
function [] = pCOH_SPKLFP_Tune_NeurRF_isect_vamp_overlap_shuff_interp_matRate(file_name,sig1_name,sig2_name)
...
if exist('MStim_') == 0 %not a uStim session
    ...
    %match spike rates for Target-in trials across SS2, SS4, and SS8
    sig2 = match_spike_rate(sig2,[100 250],in.ss2,in.ss4,in.ss8);
...
if shuffFlag == 1 & saveFlag == 1
    save(['//scratch/heitzrp/Output/Coherence/Uber_Tune_NeuronRF_intersection_shuff_matRate/overlap/' file_name '_' ...
