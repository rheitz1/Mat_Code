...
function [] = pCOH_SPKLFP_Tune_NeurRF_isect_local_overlap_ss_fast_slow_uStim(file_name,sig1_name,sig2_name)
% 
...
load(file_name,sig1_name,sig2_name, ...
    'EyeX_','MStim_','EyeY_','Target_','Errors_','newfile','Correct_','RFs','Hemi','SRT','TrialStart_')
...
in.fast.ss2 = find(isnan(MStim_(:,1)) & Correct_(:,2) == 1 & ismember(Target_(:,2),RF) & SRT(:,1) < cMed.ss2 & SRT(:,1) > 50);
in.slow.ss2 = find(isnan(MStim_(:,1)) & Correct_(:,2) == 1 & ismember(Target_(:,2),RF) & SRT(:,1) >= cMed.ss2 & SRT(:,1) < 2000);
out.fast.ss2 = find(isnan(MStim_(:,1)) & Correct_(:,2) == 1 & ismember(Target_(:,2),antiRF) & SRT(:,1) < cMed.ss2 & SRT(:,1) > 50);
out.slow.ss2 = find(isnan(MStim_(:,1)) & Correct_(:,2) == 1 & ismember(Target_(:,2),antiRF) & SRT(:,1) >= cMed.ss2 & SRT(:,1) < 2000);

in.fast.ss4 = find(isnan(MStim_(:,1)) & Correct_(:,2) == 1 & ismember(Target_(:,2),RF) & SRT(:,1) < cMed.ss4 & SRT(:,1) > 50);
in.slow.ss4 = find(isnan(MStim_(:,1)) & Correct_(:,2) == 1 & ismember(Target_(:,2),RF) & SRT(:,1) >= cMed.ss4 & SRT(:,1) < 2000);
out.fast.ss4 = find(isnan(MStim_(:,1)) & Correct_(:,2) == 1 & ismember(Target_(:,2),antiRF) & SRT(:,1) < cMed.ss4 & SRT(:,1) > 50);
out.slow.ss4 = find(isnan(MStim_(:,1)) & Correct_(:,2) == 1 & ismember(Target_(:,2),antiRF) & SRT(:,1) >= cMed.ss4 & SRT(:,1) < 2000);
  
in.fast.ss8 = find(isnan(MStim_(:,1)) & Correct_(:,2) == 1 & ismember(Target_(:,2),RF) & SRT(:,1) < cMed.ss8 & SRT(:,1) > 50);
in.slow.ss8 = find(isnan(MStim_(:,1)) & Correct_(:,2) == 1 & ismember(Target_(:,2),RF) & SRT(:,1) >= cMed.ss8 & SRT(:,1) < 2000);
out.fast.ss8 = find(isnan(MStim_(:,1)) & Correct_(:,2) == 1 & ismember(Target_(:,2),antiRF) & SRT(:,1) < cMed.ss8 & SRT(:,1) > 50);
out.slow.ss8 = find(isnan(MStim_(:,1)) & Correct_(:,2) == 1 & ismember(Target_(:,2),antiRF) & SRT(:,1) >= cMed.ss8 & SRT(:,1) < 2000);
