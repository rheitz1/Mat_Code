...
function [] = pCOH_SPKLFP_Tune_NeurRF_isect_vamp_overlap_shuff_uStim_thintape(file_name,sig1_name,sig2_name)
...
%NOTE: WITHIN_COND_SHUFF COMMENTED OUT DUE TO PROBLEMS W/ WIDE TAPERS
%3/3/10

if shuffFlag == 1 & saveFlag == 1
    save(['//scratch/heitzrp/Output/Coherence/Uber_Tune_NeuronRF_intersection_shuff_uStim/overlap/thintape/' file_name '_' ...
