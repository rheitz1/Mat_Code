...
function [] = COHERENCE_vampire_p(file)
tic
...
%for pair = 1:size(pairings,1)
    ...
    if strmatch('AD',chanlist(pairings(pair,1))) == 1 & strmatch('AD',chanlist(pairings(pair,2))) == 1
        [coh_targ.pos0,f_targ,tout_targ,spec1_targ.pos0,spec2_targ.pos0,Pcoh_targ.pos0,Pspec1_targ.pos0,Pspec2_targ.pos0] = LFP_LFPCoh(sig1_correct_pos0,sig2_correct_pos0,tapers,1000,.01,[0 80],0,-500,0,4,.05,0,2,0);
        [coh_targ.pos1,f_targ,tout_targ,spec1_targ.pos1,spec2_targ.pos1,Pcoh_targ.pos1,Pspec1_targ.pos1,Pspec2_targ.pos1] = LFP_LFPCoh(sig1_correct_pos1,sig2_correct_pos1,tapers,1000,.01,[0 80],0,-500,0,4,.05,0,2,0);
        [coh_targ.pos2,f_targ,tout_targ,spec1_targ.pos2,spec2_targ.pos2,Pcoh_targ.pos2,Pspec1_targ.pos2,Pspec2_targ.pos2] = LFP_LFPCoh(sig1_correct_pos2,sig2_correct_pos2,tapers,1000,.01,[0 80],0,-500,0,4,.05,0,2,0);
        [coh_targ.pos3,f_targ,tout_targ,spec1_targ.pos3,spec2_targ.pos3,Pcoh_targ.pos3,Pspec1_targ.pos3,Pspec2_targ.pos3] = LFP_LFPCoh(sig1_correct_pos3,sig2_correct_pos3,tapers,1000,.01,[0 80],0,-500,0,4,.05,0,2,0);
        [coh_targ.pos4,f_targ,tout_targ,spec1_targ.pos4,spec2_targ.pos4,Pcoh_targ.pos4,Pspec1_targ.pos4,Pspec2_targ.pos4] = LFP_LFPCoh(sig1_correct_pos4,sig2_correct_pos4,tapers,1000,.01,[0 80],0,-500,0,4,.05,0,2,0);
        [coh_targ.pos5,f_targ,tout_targ,spec1_targ.pos5,spec2_targ.pos5,Pcoh_targ.pos5,Pspec1_targ.pos5,Pspec2_targ.pos5] = LFP_LFPCoh(sig1_correct_pos5,sig2_correct_pos5,tapers,1000,.01,[0 80],0,-500,0,4,.05,0,2,0);
        [coh_targ.pos6,f_targ,tout_targ,spec1_targ.pos6,spec2_targ.pos6,Pcoh_targ.pos6,Pspec1_targ.pos6,Pspec2_targ.pos6] = LFP_LFPCoh(sig1_correct_pos6,sig2_correct_pos6,tapers,1000,.01,[0 80],0,-500,0,4,.05,0,2,0);
        [coh_targ.pos7,f_targ,tout_targ,spec1_targ.pos7,spec2_targ.pos7,Pcoh_targ.pos7,Pspec1_targ.pos7,Pspec2_targ.pos7] = LFP_LFPCoh(sig1_correct_pos7,sig2_correct_pos7,tapers,1000,.01,[0 80],0,-500,0,4,.05,0,2,0);
        [coh_targ.all,f_targ,tout_targ,spec1_targ.all,spec2_targ.all,Pcoh_targ.all,Pspec1_targ.all,Pspec2_targ.all] = LFP_LFPCoh(sig1_correct_all,sig2_correct_all,tapers,1000,.01,[0 80],0,-500,0,4,.05,0,2,0);
    ...
    elseif strmatch('AD',chanlist(pairings(pair,1))) == 1 & strmatch('DSP',chanlist(pairings(pair,2))) == 1
        [coh_targ.pos0,f_targ,tout_targ,spec2_targ.pos0,spec1_targ.pos0,Pcoh_targ.pos0,Pspec2_targ.pos0,Pspec1_targ.pos0] = Spk_LFPCoh(sig2_correct_pos0,sig1_correct_pos0,tapers,-500,[-500 2500],1000,.01,[0 80],0,4,.05,0,2,0);
        [coh_targ.pos1,f_targ,tout_targ,spec2_targ.pos1,spec1_targ.pos1,Pcoh_targ.pos1,Pspec2_targ.pos1,Pspec1_targ.pos1] = Spk_LFPCoh(sig2_correct_pos1,sig1_correct_pos1,tapers,-500,[-500 2500],1000,.01,[0 80],0,4,.05,0,2,0);
        [coh_targ.pos2,f_targ,tout_targ,spec2_targ.pos2,spec1_targ.pos2,Pcoh_targ.pos2,Pspec2_targ.pos2,Pspec1_targ.pos2] = Spk_LFPCoh(sig2_correct_pos2,sig1_correct_pos2,tapers,-500,[-500 2500],1000,.01,[0 80],0,4,.05,0,2,0);
        [coh_targ.pos3,f_targ,tout_targ,spec2_targ.pos3,spec1_targ.pos3,Pcoh_targ.pos3,Pspec2_targ.pos3,Pspec1_targ.pos3] = Spk_LFPCoh(sig2_correct_pos3,sig1_correct_pos3,tapers,-500,[-500 2500],1000,.01,[0 80],0,4,.05,0,2,0);
        [coh_targ.pos4,f_targ,tout_targ,spec2_targ.pos4,spec1_targ.pos4,Pcoh_targ.pos4,Pspec2_targ.pos4,Pspec1_targ.pos4] = Spk_LFPCoh(sig2_correct_pos4,sig1_correct_pos4,tapers,-500,[-500 2500],1000,.01,[0 80],0,4,.05,0,2,0);
        [coh_targ.pos5,f_targ,tout_targ,spec2_targ.pos5,spec1_targ.pos5,Pcoh_targ.pos5,Pspec2_targ.pos5,Pspec1_targ.pos5] = Spk_LFPCoh(sig2_correct_pos5,sig1_correct_pos5,tapers,-500,[-500 2500],1000,.01,[0 80],0,4,.05,0,2,0);
        [coh_targ.pos6,f_targ,tout_targ,spec2_targ.pos6,spec1_targ.pos6,Pcoh_targ.pos6,Pspec2_targ.pos6,Pspec1_targ.pos6] = Spk_LFPCoh(sig2_correct_pos6,sig1_correct_pos6,tapers,-500,[-500 2500],1000,.01,[0 80],0,4,.05,0,2,0);
        [coh_targ.pos7,f_targ,tout_targ,spec2_targ.pos7,spec1_targ.pos7,Pcoh_targ.pos7,Pspec2_targ.pos7,Pspec1_targ.pos7] = Spk_LFPCoh(sig2_correct_pos7,sig1_correct_pos7,tapers,-500,[-500 2500],1000,.01,[0 80],0,4,.05,0,2,0);
        [coh_targ.all,f_targ,tout_targ,spec2_targ.all,spec1_targ.all,Pcoh_targ.all,Pspec2_targ.all,Pspec1_targ.all] = Spk_LFPCoh(sig2_correct_all,sig1_correct_all,tapers,-500,[-500 2500],1000,.01,[0 80],0,4,.05,0,2,0);
                
        
        %both signals are spikes
    elseif strmatch('DSP',chanlist(pairings(pair,1))) == 1 & strmatch('DSP',chanlist(pairings(pair,2))) == 1
        [coh_targ.pos0,f_targ,tout_targ,spec1_targ.pos0,spec2_targ.pos0,Pcoh_targ.pos0,Pspec1_targ.pos0,Pspec2_targ.pos0] = Spk_SpkCoh(sig1_correct_pos0,sig2_correct_pos0,tapers,[-500 2500],1000,.01,[0 80],0,4,.05,0,2,0);
        [coh_targ.pos1,f_targ,tout_targ,spec1_targ.pos1,spec2_targ.pos1,Pcoh_targ.pos1,Pspec1_targ.pos1,Pspec2_targ.pos1] = Spk_SpkCoh(sig1_correct_pos1,sig2_correct_pos1,tapers,[-500 2500],1000,.01,[0 80],0,4,.05,0,2,0);
        [coh_targ.pos2,f_targ,tout_targ,spec1_targ.pos2,spec2_targ.pos2,Pcoh_targ.pos2,Pspec1_targ.pos2,Pspec2_targ.pos2] = Spk_SpkCoh(sig1_correct_pos2,sig2_correct_pos2,tapers,[-500 2500],1000,.01,[0 80],0,4,.05,0,2,0);
        [coh_targ.pos3,f_targ,tout_targ,spec1_targ.pos3,spec2_targ.pos3,Pcoh_targ.pos3,Pspec1_targ.pos3,Pspec2_targ.pos3] = Spk_SpkCoh(sig1_correct_pos3,sig2_correct_pos3,tapers,[-500 2500],1000,.01,[0 80],0,4,.05,0,2,0);
        [coh_targ.pos4,f_targ,tout_targ,spec1_targ.pos4,spec2_targ.pos4,Pcoh_targ.pos4,Pspec1_targ.pos4,Pspec2_targ.pos4] = Spk_SpkCoh(sig1_correct_pos4,sig2_correct_pos4,tapers,[-500 2500],1000,.01,[0 80],0,4,.05,0,2,0);
        [coh_targ.pos5,f_targ,tout_targ,spec1_targ.pos5,spec2_targ.pos5,Pcoh_targ.pos5,Pspec1_targ.pos5,Pspec2_targ.pos5] = Spk_SpkCoh(sig1_correct_pos5,sig2_correct_pos5,tapers,[-500 2500],1000,.01,[0 80],0,4,.05,0,2,0);
        [coh_targ.pos6,f_targ,tout_targ,spec1_targ.pos6,spec2_targ.pos6,Pcoh_targ.pos6,Pspec1_targ.pos6,Pspec2_targ.pos6] = Spk_SpkCoh(sig1_correct_pos6,sig2_correct_pos6,tapers,[-500 2500],1000,.01,[0 80],0,4,.05,0,2,0);
        [coh_targ.pos7,f_targ,tout_targ,spec1_targ.pos7,spec2_targ.pos7,Pcoh_targ.pos7,Pspec1_targ.pos7,Pspec2_targ.pos7] = Spk_SpkCoh(sig1_correct_pos7,sig2_correct_pos7,tapers,[-500 2500],1000,.01,[0 80],0,4,.05,0,2,0);
        [coh_targ.all,f_targ,tout_targ,spec1_targ.all,spec2_targ.all,Pcoh_targ.all,Pspec1_targ.all,Pspec2_targ.all] = Spk_SpkCoh(sig1_correct_all,sig2_correct_all,tapers,[-500 2500],1000,.01,[0 80],0,4,.05,0,2,0);
...
%             minCol = findMin(abs(Pcoh_targ.pos0),abs(Pcoh_targ.pos1),abs(Pcoh_targ.pos2),abs(Pcoh_targ.pos3),abs(Pcoh_targ.pos4),abs(Pcoh_targ.pos5),abs(Pcoh_targ.pos6),abs(Pcoh_targ.pos7));
        ...
        eval(['print -djpeg100 ',q,'//scratch/heitzrp/Output/Coherence/screenloc/JPG/notnormalized/',file,'_',[name1 name2 cell2mat(chanlist(pairings(pair,1))) cell2mat(chanlist(pairings(pair,2)))],'_coherence_screenloc_baseline_corrected.jpg',q])
...
%             minCol = findMin(abs(Pcoh_targ.pos0),abs(Pcoh_targ.pos1),abs(Pcoh_targ.pos2),abs(Pcoh_targ.pos3),abs(Pcoh_targ.pos4),abs(Pcoh_targ.pos5),abs(Pcoh_targ.pos6),abs(Pcoh_targ.pos7));
        ...
        eval(['print -djpeg100 ',q,'//scratch/heitzrp/Output/Coherence/screenloc/JPG/notnormalized/',file,'_',[name1 name2 cell2mat(chanlist(pairings(pair,1))) cell2mat(chanlist(pairings(pair,2)))],'_coherence_screenloc_no_baseline_correction.jpg',q])
    ...
    if saveFlag == 1
        ...
        save(['//scratch/heitzrp/Output/Coherence/screenloc/Matrices/notnormalized/' file '_' ...
