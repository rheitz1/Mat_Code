...
function [] = pCOH_LFPLFP_Tune_NeurRF_isect_vamp_overlap_shuff_uStim(file_name,sig1_name,sig2_name)
...
load(file_name,sig1_name,sig2_name, ...
    'MStim_','EyeX_','EyeY_','Target_','Errors_','newfile','Correct_','SRT','TrialStart_')
