...
function [] = pCOHERENCE_SPKLFP_Tune_NeurRF_isect_vamp_overlap_shuff_thintape(file_name,sig1_name,sig2_name)
...
if shuffFlag == 1 & saveFlag == 1
    save(['//scratch/heitzrp/Output/Coherence/Uber_Tune_NeuronRF_intersection_shuff/overlap/thintape/' file_name '_' ...
