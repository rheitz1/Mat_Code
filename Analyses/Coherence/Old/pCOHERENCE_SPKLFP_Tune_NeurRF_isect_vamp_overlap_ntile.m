...
function [] = pCOHERENCE_SPKLFP_Tune_NeurRF_isect_vamp_overlap_ntile(file_name,sig1_name,sig2_name)
...
load(file_name,sig1_name,sig2_name, ...
    'Target_','Correct_','RFs','Hemi','SRT','TrialStart_')
...
in.ss2.bin1 = find(Correct_(:,2) == 1 & ismember(Target_(:,2),RF) & Target_(:,5) == 2 & SRT(:,1) > 50 & SRT(:,1) <= nTiles.ss2(1));
in.ss2.bin2 = find(Correct_(:,2) == 1 & ismember(Target_(:,2),RF) & Target_(:,5) == 2 & SRT(:,1) > nTiles.ss2(1) & SRT(:,1) <= nTiles.ss2(2));
in.ss2.bin3 = find(Correct_(:,2) == 1 & ismember(Target_(:,2),RF) & Target_(:,5) == 2 & SRT(:,1) > nTiles.ss2(2) & SRT(:,1) <= nTiles.ss2(3));
in.ss2.bin4 = find(Correct_(:,2) == 1 & ismember(Target_(:,2),RF) & Target_(:,5) == 2 & SRT(:,1) > nTiles.ss2(3) & SRT(:,1) < 2000);

out.ss2.bin1 = find(Correct_(:,2) == 1 & ismember(Target_(:,2),antiRF) & Target_(:,5) == 2 & SRT(:,1) > 50 & SRT(:,1) <= nTiles.ss2(1));
out.ss2.bin2 = find(Correct_(:,2) == 1 & ismember(Target_(:,2),antiRF) & Target_(:,5) == 2 & SRT(:,1) > nTiles.ss2(1) & SRT(:,1) <= nTiles.ss2(2));
out.ss2.bin3 = find(Correct_(:,2) == 1 & ismember(Target_(:,2),antiRF) & Target_(:,5) == 2 & SRT(:,1) > nTiles.ss2(2) & SRT(:,1) <= nTiles.ss2(3));
out.ss2.bin4 = find(Correct_(:,2) == 1 & ismember(Target_(:,2),antiRF) & Target_(:,5) == 2 & SRT(:,1) > nTiles.ss2(3) & SRT(:,1) < 2000);
...
in.ss4.bin1 = find(Correct_(:,2) == 1 & ismember(Target_(:,2),RF) & Target_(:,5) == 4 & SRT(:,1) > 50 & SRT(:,1) <= nTiles.ss4(1));
in.ss4.bin2 = find(Correct_(:,2) == 1 & ismember(Target_(:,2),RF) & Target_(:,5) == 4 & SRT(:,1) > nTiles.ss4(1) & SRT(:,1) <= nTiles.ss4(2));
in.ss4.bin3 = find(Correct_(:,2) == 1 & ismember(Target_(:,2),RF) & Target_(:,5) == 4 & SRT(:,1) > nTiles.ss4(2) & SRT(:,1) <= nTiles.ss4(3));
in.ss4.bin4 = find(Correct_(:,2) == 1 & ismember(Target_(:,2),RF) & Target_(:,5) == 4 & SRT(:,1) > nTiles.ss4(3) & SRT(:,1) < 2000);

out.ss4.bin1 = find(Correct_(:,2) == 1 & ismember(Target_(:,2),antiRF) & Target_(:,5) == 4 & SRT(:,1) > 50 & SRT(:,1) <= nTiles.ss4(1));
out.ss4.bin2 = find(Correct_(:,2) == 1 & ismember(Target_(:,2),antiRF) & Target_(:,5) == 4 & SRT(:,1) > nTiles.ss4(1) & SRT(:,1) <= nTiles.ss4(2));
out.ss4.bin3 = find(Correct_(:,2) == 1 & ismember(Target_(:,2),antiRF) & Target_(:,5) == 4 & SRT(:,1) > nTiles.ss4(2) & SRT(:,1) <= nTiles.ss4(3));
out.ss4.bin4 = find(Correct_(:,2) == 1 & ismember(Target_(:,2),antiRF) & Target_(:,5) == 4 & SRT(:,1) > nTiles.ss4(3) & SRT(:,1) < 2000);
...
in.ss8.bin1 = find(Correct_(:,2) == 1 & ismember(Target_(:,2),RF) & Target_(:,5) == 8 & SRT(:,1) > 50 & SRT(:,1) <= nTiles.ss8(1));
in.ss8.bin2 = find(Correct_(:,2) == 1 & ismember(Target_(:,2),RF) & Target_(:,5) == 8 &SRT(:,1) > nTiles.ss8(1) & SRT(:,1) <= nTiles.ss8(2));
in.ss8.bin3 = find(Correct_(:,2) == 1 & ismember(Target_(:,2),RF) & Target_(:,5) == 8 &SRT(:,1) > nTiles.ss8(2) & SRT(:,1) <= nTiles.ss8(3));
in.ss8.bin4 = find(Correct_(:,2) == 1 & ismember(Target_(:,2),RF) & Target_(:,5) == 8 &SRT(:,1) > nTiles.ss8(3) & SRT(:,1) < 2000);

out.ss8.bin1 = find(Correct_(:,2) == 1 & ismember(Target_(:,2),antiRF) & Target_(:,5) == 8 &SRT(:,1) > 50 & SRT(:,1) <= nTiles.ss8(1));
out.ss8.bin2 = find(Correct_(:,2) == 1 & ismember(Target_(:,2),antiRF) & Target_(:,5) == 8 &SRT(:,1) > nTiles.ss8(1) & SRT(:,1) <= nTiles.ss8(2));
out.ss8.bin3 = find(Correct_(:,2) == 1 & ismember(Target_(:,2),antiRF) & Target_(:,5) == 8 &SRT(:,1) > nTiles.ss8(2) & SRT(:,1) <= nTiles.ss8(3));
out.ss8.bin4 = find(Correct_(:,2) == 1 & ismember(Target_(:,2),antiRF) & Target_(:,5) == 8 &SRT(:,1) > nTiles.ss8(3) & SRT(:,1) < 2000);
