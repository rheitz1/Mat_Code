...
function [] = pCOHERENCE_SPKLFP_Tune_NeurRF_isect_vamp_nooverlap_shuff_highp(file_name,sig1_name,sig2_name)
...
if saveFlag == 1
    save(['//scratch/heitzrp/Output/Coherence/Uber_Hemi_NeuronRF_intersection_shuff/nooverlap/' file_name '_' ...
