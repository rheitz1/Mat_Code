...
%%SET_SIZE REGULAR (not baseline-correct_ss4ed)
clear all
 
cd /volumes/dump2/Coherence/Uber/Matrices/
%batch_list = dir('/volumes/dump2/JPSTC/JPSTC_matrices/reg/correct_ss4_target_truncated_filtered_nosaturation/LFP-LFP/*.mat');
batch_list = dir('*.mat');
...
%Note: error in coherence code accidentally set sig1_resp_correct_ss4 and
%sig1_resp_correct_ss4 to x_targ_x.
