...
function [] = pCOHERENCE_normalized_SPKLFP_Hemi_NeurRF_isect_vamp_overlap(file_name,sig1_name,sig2_name)
...
if saveFlag == 1
    save(['//scratch/heitzrp/Output/Coherence/Uber_Hemi_NeuronRF_intersection/overlap/' file_name '_' ...
