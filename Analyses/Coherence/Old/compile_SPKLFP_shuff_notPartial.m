...
for sess = 1:length(file_list);
    ...
    coh_all.in.all_sub(1:281,1:104,sess) = coh.in.all_sub;
    coh_all.in.all(1:281,1:104,sess) = coh.in.all;
    coh_all.in.ss2(1:281,1:104,sess) = coh.in.ss2;
    coh_all.in.ss4(1:281,1:104,sess) = coh.in.ss4;
    coh_all.in.ss8(1:281,1:104,sess) = coh.in.ss8;
    coh_all.in.fast(1:281,1:104,sess) = coh.in.fast;
    coh_all.in.slow(1:281,1:104,sess) = coh.in.slow;
    coh_all.in.err(1:281,1:104,sess) = coh.in.err;
    
    coh_all.out.all_sub(1:281,1:104,sess) = coh.out.all_sub;
    coh_all.out.all(1:281,1:104,sess) = coh.out.all;
    coh_all.out.ss2(1:281,1:104,sess) = coh.out.ss2;
    coh_all.out.ss4(1:281,1:104,sess) = coh.out.ss4;
    coh_all.out.ss8(1:281,1:104,sess) = coh.out.ss8;
    coh_all.out.fast(1:281,1:104,sess) = coh.out.fast;
    coh_all.out.slow(1:281,1:104,sess) = coh.out.slow;
    coh_all.out.err(1:281,1:104,sess) = coh.out.err;
    
    
    %========================
    shuff_all.in.all.coh(1:281,1:21,sess) = between_cond_shuff.all.TrType1.coh;
    shuff_all.out.all.coh(1:281,1:21,sess) = between_cond_shuff.all.TrType2.coh;
    ...
    %=========================
    shuff_all.in.ss2.coh(1:281,1:21,sess) = between_cond_shuff.ss2.TrType1.coh;
    shuff_all.out.ss2.coh(1:281,1:21,sess) = between_cond_shuff.ss2.TrType2.coh;
    shuff_all.in_v_out.ss2.Pos(1:61,1:21,sess) = between_cond_shuff.ss2.Coh.Pos.SigClusAssign;
    shuff_all.in_v_out.ss2.Neg(1:61,1:21,sess) = between_cond_shuff.ss2.Coh.Neg.SigClusAssign;
    ...
    shuff_all.base_v_act.in.ss2.Pos(1:61,1:21,sess) = within_cond_shuff.in.ss2.Coh.Pos.SigClusAssign;
    shuff_all.base_v_act.in.ss2.Neg(1:61,1:21,sess) = within_cond_shuff.in.ss2.Coh.Neg.SigClusAssign;
    shuff_all.base_v_act.out.ss2.Pos(1:61,1:21,sess) = within_cond_shuff.out.ss2.Coh.Pos.SigClusAssign;
    shuff_all.base_v_act.out.ss2.Neg(1:61,1:21,sess) = within_cond_shuff.out.ss2.Coh.Neg.SigClusAssign;
    ...
    %==========================
    shuff_all.in.ss4.coh(1:281,1:21,sess) = between_cond_shuff.ss4.TrType1.coh;
    shuff_all.out.ss4.coh(1:281,1:21,sess) = between_cond_shuff.ss4.TrType2.coh;
    shuff_all.in_v_out.ss4.Pos(1:61,1:21,sess) = between_cond_shuff.ss4.Coh.Pos.SigClusAssign;
    shuff_all.in_v_out.ss4.Neg(1:61,1:21,sess) = between_cond_shuff.ss4.Coh.Neg.SigClusAssign;
    ...
    shuff_all.base_v_act.in.ss4.Pos(1:61,1:21,sess) = within_cond_shuff.in.ss4.Coh.Pos.SigClusAssign;
    shuff_all.base_v_act.in.ss4.Neg(1:61,1:21,sess) = within_cond_shuff.in.ss4.Coh.Neg.SigClusAssign;
    shuff_all.base_v_act.out.ss4.Pos(1:61,1:21,sess) = within_cond_shuff.out.ss4.Coh.Pos.SigClusAssign;
    shuff_all.base_v_act.out.ss4.Neg(1:61,1:21,sess) = within_cond_shuff.out.ss4.Coh.Neg.SigClusAssign;
    ...
    %===========================
    shuff_all.in.ss8.coh(1:281,1:21,sess) = between_cond_shuff.ss8.TrType1.coh;
    shuff_all.out.ss8.coh(1:281,1:21,sess) = between_cond_shuff.ss8.TrType2.coh;
    shuff_all.in_v_out.ss8.Pos(1:61,1:21,sess) = between_cond_shuff.ss8.Coh.Pos.SigClusAssign;
    shuff_all.in_v_out.ss8.Neg(1:61,1:21,sess) = between_cond_shuff.ss8.Coh.Neg.SigClusAssign;
    ...
    shuff_all.base_v_act.in.ss8.Pos(1:61,1:21,sess) = within_cond_shuff.in.ss8.Coh.Pos.SigClusAssign;
    shuff_all.base_v_act.in.ss8.Neg(1:61,1:21,sess) = within_cond_shuff.in.ss8.Coh.Neg.SigClusAssign;
    shuff_all.base_v_act.out.ss8.Pos(1:61,1:21,sess) = within_cond_shuff.out.ss8.Coh.Pos.SigClusAssign;
    shuff_all.base_v_act.out.ss8.Neg(1:61,1:21,sess) = within_cond_shuff.out.ss8.Coh.Neg.SigClusAssign;
    ...
    %===========================
    shuff_all.in.fast.coh(1:281,1:21,sess) = between_cond_shuff.fast.TrType1.coh;
    shuff_all.out.fast.coh(1:281,1:21,sess) = between_cond_shuff.fast.TrType2.coh;
    shuff_all.in_v_out.fast.Pos(1:61,1:21,sess) = between_cond_shuff.fast.Coh.Pos.SigClusAssign;
    shuff_all.in_v_out.fast.Neg(1:61,1:21,sess) = between_cond_shuff.fast.Coh.Neg.SigClusAssign;
    ...
    shuff_all.base_v_act.in.fast.Pos(1:61,1:21,sess) = within_cond_shuff.in.fast.Coh.Pos.SigClusAssign;
    shuff_all.base_v_act.in.fast.Neg(1:61,1:21,sess) = within_cond_shuff.in.fast.Coh.Neg.SigClusAssign;
    shuff_all.base_v_act.out.fast.Pos(1:61,1:21,sess) = within_cond_shuff.out.fast.Coh.Pos.SigClusAssign;
    shuff_all.base_v_act.out.fast.Neg(1:61,1:21,sess) = within_cond_shuff.out.fast.Coh.Neg.SigClusAssign;
    ...
    %===========================
    shuff_all.in.slow.coh(1:281,1:21,sess) = between_cond_shuff.slow.TrType1.coh;
    shuff_all.out.slow.coh(1:281,1:21,sess) = between_cond_shuff.slow.TrType2.coh;
    shuff_all.in_v_out.slow.Pos(1:61,1:21,sess) = between_cond_shuff.slow.Coh.Pos.SigClusAssign;
    shuff_all.in_v_out.slow.Neg(1:61,1:21,sess) = between_cond_shuff.slow.Coh.Neg.SigClusAssign;
    ...
    shuff_all.base_v_act.in.slow.Pos(1:61,1:21,sess) = within_cond_shuff.in.slow.Coh.Pos.SigClusAssign;
    shuff_all.base_v_act.in.slow.Neg(1:61,1:21,sess) = within_cond_shuff.in.slow.Coh.Neg.SigClusAssign;
    shuff_all.base_v_act.out.slow.Pos(1:61,1:21,sess) = within_cond_shuff.out.slow.Coh.Pos.SigClusAssign;
    shuff_all.base_v_act.out.slow.Neg(1:61,1:21,sess) = within_cond_shuff.out.slow.Coh.Neg.SigClusAssign;
    ...
    try
        shuff_all.in.err.coh(1:281,1:21,sess) = between_cond_shuff.err.TrType1.coh;
        shuff_all.out.err.coh(1:281,1:21,sess) = between_cond_shuff.err.TrType2.coh;
        shuff_all.in_v_out.err.Pos(1:61,1:21,sess) = between_cond_shuff.err.Coh.Pos.SigClusAssign;
        shuff_all.in_v_out.err.Neg(1:61,1:21,sess) = between_cond_shuff.err.Coh.Neg.SigClusAssign;
        ...
        shuff_all.base_v_act.in.err.Pos(1:61,1:21,sess) = within_cond_shuff.in.err.Coh.Pos.SigClusAssign;
        shuff_all.base_v_act.in.err.Neg(1:61,1:21,sess) = within_cond_shuff.in.err.Coh.Neg.SigClusAssign;
        shuff_all.base_v_act.out.err.Pos(1:61,1:21,sess) = within_cond_shuff.out.err.Coh.Pos.SigClusAssign;
        shuff_all.base_v_act.out.err.Neg(1:61,1:21,sess) = within_cond_shuff.out.err.Coh.Neg.SigClusAssign;
        ...
        shuff_all.in_v_in.corr_err.Pos(1:61,1:21,sess) = between_cond_shuff.corr_err.Coh.Pos.SigClusAssign;
        shuff_all.in_v_in.corr_err.Neg(1:61,1:21,sess) = between_cond_shuff.corr_err.Coh.Neg.SigClusAssign;
        
    catch
        shuff_all.in.err.coh(1:281,1:21,sess) = NaN;
        shuff_all.out.err.coh(1:281,1:21,sess) = NaN;
        shuff_all.in_v_out.err.Pos(1:61,1:21,sess) = NaN;
        shuff_all.in_v_out.err.Neg(1:61,1:21,sess) = NaN;
        shuff_all.in_v_out.err.Pos_TFCens(1,1:2,sess) = NaN;
        shuff_all.in_v_out.err.Neg_TFCens(1,1:2,sess) = NaN;
        
        
        shuff_all.base_v_act.in.err.Pos(1:61,1:21,sess) = NaN;
        shuff_all.base_v_act.in.err.Neg(1:61,1:21,sess) = NaN;
        shuff_all.base_v_act.out.err.Pos(1:61,1:21,sess) = NaN;
        shuff_all.base_v_act.out.err.Neg(1:61,1:21,sess) = NaN;
        ...
        shuff_all.in_v_in.corr_err.Pos(1:61,1:21,sess) = NaN;
        shuff_all.in_v_in.corr_err.Neg(1:61,1:21,sess) = NaN;
        
    end
    
    
    shuff_all.in_v_in.fast_slow.Pos(1:61,1:21,sess) = between_cond_shuff.fast_slow.Coh.Pos.SigClusAssign;
    shuff_all.in_v_in.fast_slow.Neg(1:61,1:21,sess) = between_cond_shuff.fast_slow.Coh.Neg.SigClusAssign;
    ...
    keep tout_shuff normshuff_all shuff_all n tout f coh_all coh_all TDT_all Sx_all Sy_all ...
...
if plotFlag == 1
    ...
    figure
    subplot(2,2,1)
    imagesc(tout,f,nanmean(abs(coh_all.in),3)')
    axis xy
    xlim([-50 500])
    colorbar
    title('In')
    ...
    subplot(2,2,2)
    imagesc(tout,f,nanmean(abs(coh_all.out),3)')
    axis xy
    xlim([-50 500])
    colorbar
    title('Out')
    ...
    diff = nanmean(abs(coh_all.in),3)' - nanmean(abs(coh_all.out),3)';
    ...
    figure
    subplot(2,2,1)
    re.in = nanmean(real(coh_all.in),3);
    im.in = nanmean(imag(coh_all.in),3);
    ...
    subplot(2,2,2)
    re.out = nanmean(real(coh_all.out),3);
    im.out = nanmean(imag(coh_all.out),3);
