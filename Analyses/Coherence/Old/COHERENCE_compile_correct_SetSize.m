...
%%SET_SIZE REGULAR (not baseline-correct_ss2ed)
clear all

cd /volumes/dump2/Coherence/Uber/Matrices/LFP-LFP
%batch_list = dir('/volumes/dump2/JPSTC/JPSTC_matrices/reg/correct_ss2_target_truncated_filtered_nosaturation/LFP-LFP/*.mat');
batch_list = dir('*.mat');
...
spec1_targ_all.correct_ss2(1:281,1:206,1:length(batch_list)) = NaN;
spec1_resp_all.correct_ss2(1:71,1:206,1:length(batch_list)) = NaN;

spec2_targ_all.correct_ss2(1:281,1:206,1:length(batch_list)) = NaN;
spec2_resp_all.correct_ss2(1:71,1:206,1:length(batch_list)) = NaN;

coh_targ_all.correct_ss4(1:281,1:206,1:length(batch_list)) = NaN;
coh_resp_all.correct_ss4(1:71,1:206,1:length(batch_list)) = NaN;

spec1_targ_all.correct_ss4(1:281,1:206,1:length(batch_list)) = NaN;
spec1_resp_all.correct_ss4(1:71,1:206,1:length(batch_list)) = NaN;

spec2_targ_all.correct_ss4(1:281,1:206,1:length(batch_list)) = NaN;
spec2_resp_all.correct_ss4(1:71,1:206,1:length(batch_list)) = NaN;
...
%Note: error in coherence code accidentally set sig1_resp_correct_ss2 and
%sig1_resp_correct_ss2 to x_targ_x.
...
for sess = 1:length(batch_list)
    ...
    spec1_targ_all.correct_ss2(1:281,1:206,sess) = spec1_targ.correct_ss2;
    spec1_resp_all.correct_ss2(1:71,1:206,sess) = spec1_resp.correct_ss2;
    
    spec2_targ_all.correct_ss2(1:281,1:206,sess) = spec2_targ.correct_ss2;
    spec2_resp_all.correct_ss2(1:71,1:206,sess) = spec2_resp.correct_ss2;
    ...
    spec1_targ_all.correct_ss4(1:281,1:206,sess) = spec1_targ.correct_ss4;
    spec1_resp_all.correct_ss4(1:71,1:206,sess) = spec1_resp.correct_ss4;
    
    spec2_targ_all.correct_ss4(1:281,1:206,sess) = spec2_targ.correct_ss4;
    spec2_resp_all.correct_ss4(1:71,1:206,sess) = spec2_resp.correct_ss4;
