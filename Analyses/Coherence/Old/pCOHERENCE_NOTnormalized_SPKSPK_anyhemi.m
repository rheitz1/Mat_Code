...
for sess = 1:length(file_name)
    ...
    [coh.in.all, f, tout, Sx.in.all, Sy.in.all, Pcoh.in.all, PSx.in.all, PSy.in.all] = Spk_SpkCoh(sig1(in.all,:),sig2(in.all,:),tapers,[-500 2500],1000,.01,[0 100],0,4,.05,0,2,0);
    ...
    [coh.in.ss2, f, tout, Sx.in.ss2, Sy.in.ss2, Pcoh.in.ss2, PSx.in.ss2, PSy.in.ss2] = Spk_SpkCoh(sig1(in.ss2,:),sig2(in.ss2,:),tapers,[-500 2500],1000,.01,[0 100],0,4,.05,0,2,0);
    ...
    [coh.in.ss4, f, tout, Sx.in.ss4, Sy.in.ss4, Pcoh.in.ss4, PSx.in.ss4, PSy.in.ss4] = Spk_SpkCoh(sig1(in.ss4,:),sig2(in.ss4,:),tapers,[-500 2500],1000,.01,[0 100],0,4,.05,0,2,0);
    ...
    [coh.in.ss8, f, tout, Sx.in.ss8, Sy.in.ss8, Pcoh.in.ss8, PSx.in.ss8, PSy.in.ss8] = Spk_SpkCoh(sig1(in.ss8,:),sig2(in.ss8,:),tapers,[-500 2500],1000,.01,[0 100],0,4,.05,0,2,0);
    ...
    [coh.in.fast, f, tout, Sx.in.fast, Sy.in.fast, Pcoh.in.fast, PSx.in.fast, PSy.in.fast] = Spk_SpkCoh(sig1(in.fast,:),sig2(in.fast,:),tapers,[-500 2500],1000,.01,[0 100],0,4,.05,0,2,0);
    ...
    [coh.in.slow, f, tout, Sx.in.slow, Sy.in.slow, Pcoh.in.slow, PSx.in.slow, PSy.in.slow] = Spk_SpkCoh(sig1(in.slow,:),sig2(in.slow,:),tapers,[-500 2500],1000,.01,[0 100],0,4,.05,0,2,0);
    ...
    [coh.in.err, f, tout, Sx.in.err, Sy.in.err, Pcoh.in.err, PSx.in.err, PSy.in.err] = Spk_SpkCoh(sig1(in.err,:),sig2(in.err,:),tapers,[-500 2500],1000,.01,[0 100],0,4,.05,0,2,0);
    ...
    [coh.out.all, f, tout, Sx.out.all, Sy.out.all, Pcoh.out.all, PSx.out.all, PSy.out.all] = Spk_SpkCoh(sig1(out.all,:),sig2(out.all,:),tapers,[-500 2500],1000,.01,[0 100],0,4,.05,0,2,0);
    ...
    [coh.out.ss2, f, tout, Sx.out.ss2, Sy.out.ss2, Pcoh.out.ss2, PSx.out.ss2, PSy.out.ss2] = Spk_SpkCoh(sig1(out.ss2,:),sig2(out.ss2,:),tapers,[-500 2500],1000,.01,[0 100],0,4,.05,0,2,0);
    ...
    [coh.out.ss4, f, tout, Sx.out.ss4, Sy.out.ss4, Pcoh.out.ss4, PSx.out.ss4, PSy.out.ss4] = Spk_SpkCoh(sig1(out.ss4,:),sig2(out.ss4,:),tapers,[-500 2500],1000,.01,[0 100],0,4,.05,0,2,0);
    ...
    [coh.out.ss8, f, tout, Sx.out.ss8, Sy.out.ss8, Pcoh.out.ss8, PSx.out.ss8, PSy.out.ss8] = Spk_SpkCoh(sig1(out.ss8,:),sig2(out.ss8,:),tapers,[-500 2500],1000,.01,[0 100],0,4,.05,0,2,0);
    ...
    [coh.out.fast, f, tout, Sx.out.fast, Sy.out.fast, Pcoh.out.fast, PSx.out.fast, PSy.out.fast] = Spk_SpkCoh(sig1(out.fast,:),sig2(out.fast,:),tapers,[-500 2500],1000,.01,[0 100],0,4,.05,0,2,0);
    ...
    [coh.out.slow, f, tout, Sx.out.slow, Sy.out.slow, Pcoh.out.slow, PSx.out.slow, PSy.out.slow] = Spk_SpkCoh(sig1(out.slow,:),sig2(out.slow,:),tapers,[-500 2500],1000,.01,[0 100],0,4,.05,0,2,0);
    ...
    [coh.out.err, f, tout, Sx.out.err, Sy.out.err, Pcoh.out.err, PSx.out.err, PSy.out.err] = Spk_SpkCoh(sig1(out.err,:),sig2(out.err,:),tapers,[-500 2500],1000,.01,[0 100],0,4,.05,0,2,0);
    ...
    if saveFlag == 1
        save(['/volumes/Dump2/Coherence/Uber/NotNormalized/SPK-SPK/' file_name{sess} '_' ...
