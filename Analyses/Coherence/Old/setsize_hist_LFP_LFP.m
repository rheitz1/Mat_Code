...
for sess = 1:size(coh_targ_all.correct_ss2,3)
    ...
    %NOTE: USING TRANSPOSED MATRIX
        ...
        %baseline correct for LFP-LFP comparisons
        uncorrected_ss2(1:206,1:281,sess) = baseline_correct(uncorrected_ss2(:,:,sess),[1 11]); %corresponds to -400:-300
        uncorrected_ss4(1:206,1:281,sess) = baseline_correct(uncorrected_ss4(:,:,sess),[1 11]);
        uncorrected_ss8(1:206,1:281,sess) = baseline_correct(uncorrected_ss8(:,:,sess),[1 11]);
        
        corrected_ss2(1:206,1:281,sess) = baseline_correct(corrected_ss2(:,:,sess),[1 11]);
        corrected_ss4(1:206,1:281,sess) = baseline_correct(corrected_ss4(:,:,sess),[1 11]);
        corrected_ss8(1:206,1:281,sess) = baseline_correct(corrected_ss8(:,:,sess),[1 11]);
...
figure
subplot(2,2,1)
plot(0:10:200,uncorrectedpow_ss2_alpha)
ylim([-.25 .7])
fon
title('Set Size 2')

subplot(2,2,2)
plot(0:10:200,uncorrectedpow_ss4_alpha)
ylim([-.25 .7])
fon
title('Set Size 4')

subplot(2,2,3)
plot(0:10:200,uncorrectedpow_ss8_alpha)
ylim([-.25 .7])
fon
title('Set Size 8')
[ax h] = suplabel('UNCORRECTED Alpha Band Power','t');
set(h,'fontsize',14,'fontweight','bold')
...
figure
subplot(2,2,1)
plot(0:10:200,correctedpow_ss2_alpha)
ylim([-.25 .7])
fon
title('Set Size 2')

subplot(2,2,2)
plot(0:10:200,correctedpow_ss4_alpha)
ylim([-.25 .7])
fon
title('Set Size 4')

subplot(2,2,3)
plot(0:10:200,correctedpow_ss8_alpha)
ylim([-.25 .7])
fon
title('Set Size 8')
[ax h] = suplabel('SHIFT-CORRECTED Alpha Band Power','t');
set(h,'fontsize',14,'fontweight','bold')
...
figure
subplot(2,2,1)
plot(0:10:200,SHIFTpow_ss2_alpha)
ylim([-.25 .7])
fon
title('Set Size 2')

subplot(2,2,2)
plot(0:10:200,SHIFTpow_ss4_alpha)
ylim([-.25 .7])
fon
title('Set Size 4')

subplot(2,2,3)
plot(0:10:200,SHIFTpow_ss8_alpha)
ylim([-.25 .7])
fon
title('Set Size 8')

[ax h] = suplabel('SHIFT PREDICTOR Alpha Band Power','t');
set(h,'fontsize',14,'fontweight','bold')
...
%for set size 8
for sess = 1:size(uncorrectedpow_ss8_alpha,1)
    if max(uncorrectedpow_ss8_alpha(sess,:)) >= .2
        alphaTrials(sess,1) = 1;
    else
        alphaTrials(sess,1) = 0;
    end
end

uncorrected_alphaTrials_ss2 = uncorrected_ss2(:,:,find(alphaTrials));
uncorrected_alphaTrials_ss4 = uncorrected_ss4(:,:,find(alphaTrials));
uncorrected_alphaTrials_ss8 = uncorrected_ss8(:,:,find(alphaTrials));

corrected_alphaTrials_ss2 = corrected_ss2(:,:,find(alphaTrials));
corrected_alphaTrials_ss4 = corrected_ss4(:,:,find(alphaTrials));
corrected_alphaTrials_ss8 = corrected_ss8(:,:,find(alphaTrials));


uncorrectedpow_alphaTrials_ss2 = uncorrectedpow_ss2_alpha(find(alphaTrials),:);
uncorrectedpow_alphaTrials_ss4 = uncorrectedpow_ss4_alpha(find(alphaTrials),:);
uncorrectedpow_alphaTrials_ss8 = uncorrectedpow_ss8_alpha(find(alphaTrials),:);

correctedpow_alphaTrials_ss2 = correctedpow_ss2_alpha(find(alphaTrials),:);
correctedpow_alphaTrials_ss4 = correctedpow_ss4_alpha(find(alphaTrials),:);
correctedpow_alphaTrials_ss8 = correctedpow_ss8_alpha(find(alphaTrials),:);


%test power band
for time = 1:length(0:10:200)
    [p(time) h(time)] = ranksum(uncorrected_alphaTrials_ss2(:,time),uncorrected_alphaTrials_ss4(:,time),'alpha',.01);
end

%Plot coherence limited to trials that actually show alpha band power
figure
subplot(2,2,1)
imagesc(tout_targ,f_targ,nanmean(uncorrected_alphaTrials_ss2,3))
axis xy
xlim([-100 500])
ylim([0 100])
colorbar
...
subplot(2,2,2)
imagesc(tout_targ,f_targ,nanmean(uncorrected_alphaTrials_ss4,3))
axis xy
xlim([-100 500])
ylim([0 100])
colorbar
...
subplot(2,2,3)
imagesc(tout_targ,f_targ,nanmean(uncorrected_alphaTrials_ss8,3))
axis xy
xlim([-100 500])
ylim([0 100])
colorbar
...
figure
subplot(2,2,1)
imagesc(tout_targ,f_targ,nanmean(corrected_alphaTrials_ss2,3))
axis xy
xlim([-100 500])
ylim([0 100])
colorbar
...
subplot(2,2,2)
imagesc(tout_targ,f_targ,nanmean(corrected_alphaTrials_ss4,3))
axis xy
xlim([-100 500])
ylim([0 100])
colorbar
...
subplot(2,2,3)
imagesc(tout_targ,f_targ,nanmean(corrected_alphaTrials_ss8,3))
axis xy
xlim([-100 500])
ylim([0 100])
colorbar
