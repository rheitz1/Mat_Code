...
function [] = pCOHERENCE_normalized_SPKLFP_vampire_overlap(file_name,sig1_name,sig2_name)
...
if saveFlag == 1
    save(['/scratch/heitzrp/Output/Coherence/Uber/SPKLFP_overlap/' file_name '_' ...
