...
function [] = pCOH_SPKLFP_Tune_NeurRF_isect_vamp_overlap_shuff_uStim_zscore(file_name,sig1_name,sig2_name)
...
cMed = nanmedian(SRT(find(isnan(MStim_(:,1)) & Correct_(:,2) == 1 & Target_(:,2) ~= 255 & SRT(:,1) < 2000 & SRT(:,1) > 50),1));
...
[~,~,~,~,~,~,~,~,~,~,~,between_cond_shuff.all,~,~] = Spk_LFPCoh(sig2(alltr,:),sig1(alltr,:),tapers,-500,[-500 2500], 1000, .01, [0 100],0,4,.05,0,2,1,ClusShuffOpts);
clear alltr
...
[~,~,~,~,~,~,~,~,~,~,~,within_cond_shuff.in.all] = Spk_LFPCoh(sig2(in.all,:),sig1(in.all,:),tapers,-500,[-500 2500], 1000, .01, [0 100],0,4,.05,0,2,1,ClusShuffOpts);
[~,~,~,~,~,~,~,~,~,~,~,within_cond_shuff.out.all] = Spk_LFPCoh(sig2(out.all,:),sig1(out.all,:),tapers,-500,[-500 2500], 1000, .01, [0 100],0,4,.05,0,2,1,ClusShuffOpts);

%without shuffling (pad == 4) & no tests
[coh.in.all,f,tout,Sx.in.all,Sy.in.all,Pcoh.in.all,PSx.in.all,PSy.in.all,] = Spk_LFPCoh(sig2(in.all,:),sig1(in.all,:),tapers,-500,[-500 2500], 1000, .01, [0 100],0,4,.05,0,2,1);
[coh.out.all,f,tout,Sx.out.all,Sy.out.all,Pcoh.out.all,PSx.out.all,PSy.out.all] = Spk_LFPCoh(sig2(out.all,:),sig1(out.all,:),tapers,-500,[-500 2500], 1000, .01, [0 100],0,4,.05,0,2,1);
%=======================
...
%with shuffling (pad = 0) & between condition tests
[~,~,~,~,~,~,~,~,~,~,~,between_cond_shuff.ss2,~,~] = Spk_LFPCoh(sig2(alltr,:),sig1(alltr,:),tapers,-500,[-500 2500], 1000, .01, [0 100],0,4,.05,0,2,1,ClusShuffOpts);
clear alltr
ClusShuffOpts.TrType = [];

%with shuffling (pad = 0) vsBaseline test
ClusShuffOpts.TestType = 1;
[~,~,~,~,~,~,~,~,~,~,~,within_cond_shuff.in.ss2] = Spk_LFPCoh(sig2(in.ss2,:),sig1(in.ss2,:),tapers,-500,[-500 2500], 1000, .01, [0 100],0,4,.05,0,2,1,ClusShuffOpts);
[~,~,~,~,~,~,~,~,~,~,~,within_cond_shuff.out.ss2] = Spk_LFPCoh(sig2(out.ss2,:),sig1(out.ss2,:),tapers,-500,[-500 2500], 1000, .01, [0 100],0,4,.05,0,2,1,ClusShuffOpts);

%without shuffling (pad == 4) no tests
[coh.in.ss2,f,tout,Sx.in.ss2,Sy.in.ss2,Pcoh.in.ss2,PSx.in.ss2,PSy.in.ss2] = Spk_LFPCoh(sig2(in.ss2,:),sig1(in.ss2,:),tapers,-500,[-500 2500], 1000, .01, [0 100],0,4,.05,0,2,1);
[coh.out.ss2,f,tout,Sx.out.ss2,Sy.out.ss2,Pcoh.out.ss2,PSx.out.ss2,PSy.out.ss2] = Spk_LFPCoh(sig2(out.ss2,:),sig1(out.ss2,:),tapers,-500,[-500 2500], 1000, .01, [0 100],0,4,.05,0,2,1);
%=======================
...
%with shuffling (pad = 0) & between condition tests
[~,~,~,~,~,~,~,~,~,~,~,between_cond_shuff.ss4,~,~] = Spk_LFPCoh(sig2(alltr,:),sig1(alltr,:),tapers,-500,[-500 2500], 1000, .01, [0 100],0,4,.05,0,2,1,ClusShuffOpts);
clear alltr
ClusShuffOpts.TrType = [];

%with shuffling (pad = 0) & vsBaseline test
ClusShuffOpts.TestType = 1;
[~,~,~,~,~,~,~,~,~,~,~,within_cond_shuff.in.ss4] = Spk_LFPCoh(sig2(in.ss4,:),sig1(in.ss4,:),tapers,-500,[-500 2500], 1000, .01, [0 100],0,4,.05,0,2,1,ClusShuffOpts);
[~,~,~,~,~,~,~,~,~,~,~,within_cond_shuff.out.ss4] = Spk_LFPCoh(sig2(out.ss4,:),sig1(out.ss4,:),tapers,-500,[-500 2500], 1000, .01, [0 100],0,4,.05,0,2,1,ClusShuffOpts);

%without shuffling (pad == 4) & no tests
[coh.in.ss4,f,tout,Sx.in.ss4,Sy.in.ss4,Pcoh.in.ss4,PSx.in.ss4,PSy.in.ss4] = Spk_LFPCoh(sig2(in.ss4,:),sig1(in.ss4,:),tapers,-500,[-500 2500], 1000, .01, [0 100],0,4,.05,0,2,1);
[coh.out.ss4,f,tout,Sx.out.ss4,Sy.out.ss4,Pcoh.out.ss4,PSx.out.ss4,PSy.out.ss4] = Spk_LFPCoh(sig2(out.ss4,:),sig1(out.ss4,:),tapers,-500,[-500 2500], 1000, .01, [0 100],0,4,.05,0,2,1);
%=======================
...
%with shuffling (pad = 0) & between condition tests
[~,~,~,~,~,~,~,~,~,~,~,between_cond_shuff.ss8,~,~] = Spk_LFPCoh(sig2(alltr,:),sig1(alltr,:),tapers,-500,[-500 2500], 1000, .01, [0 100],0,4,.05,0,2,1,ClusShuffOpts);
clear alltr
ClusShuffOpts.TrType = [];

%with shuffling (pad = 0) & vsBaseline test
ClusShuffOpts.TestType = 1;
[~,~,~,~,~,~,~,~,~,~,~,within_cond_shuff.in.ss8] = Spk_LFPCoh(sig2(in.ss8,:),sig1(in.ss8,:),tapers,-500,[-500 2500], 1000, .01, [0 100],0,4,.05,0,2,1,ClusShuffOpts);
[~,~,~,~,~,~,~,~,~,~,~,within_cond_shuff.out.ss8] = Spk_LFPCoh(sig2(out.ss8,:),sig1(out.ss8,:),tapers,-500,[-500 2500], 1000, .01, [0 100],0,4,.05,0,2,1,ClusShuffOpts);

%without shuffling (pad == 4) & no tests

[coh.in.ss8,f,tout,Sx.in.ss8,Sy.in.ss8,Pcoh.in.ss8,PSx.in.ss8,PSy.in.ss8] = Spk_LFPCoh(sig2(in.ss8,:),sig1(in.ss8,:),tapers,-500,[-500 2500], 1000, .01, [0 100],0,4,.05,0,2,1);
[coh.out.ss8,f,tout,Sx.out.ss8,Sy.out.ss8,Pcoh.out.ss8,PSx.out.ss8,PSy.out.ss8] = Spk_LFPCoh(sig2(out.ss8,:),sig1(out.ss8,:),tapers,-500,[-500 2500], 1000, .01, [0 100],0,4,.05,0,2,1);
%=======================
...
%with shuffling (pad = 0) & between condition tests
[~,~,~,~,~,~,~,~,~,~,~,between_cond_shuff.fast,~,~] = Spk_LFPCoh(sig2(alltr,:),sig1(alltr,:),tapers,-500,[-500 2500], 1000, .01, [0 100],0,4,.05,0,2,1,ClusShuffOpts);
clear alltr
ClusShuffOpts.TrType = [];

%with shuffling (pad = 0) & vsBaseline test
ClusShuffOpts.TestType = 1;
[~,~,~,~,~,~,~,~,~,~,~,within_cond_shuff.in.fast] = Spk_LFPCoh(sig2(in.fast,:),sig1(in.fast,:),tapers,-500,[-500 2500], 1000, .01, [0 100],0,4,.05,0,2,1,ClusShuffOpts);
[~,~,~,~,~,~,~,~,~,~,~,within_cond_shuff.out.fast] = Spk_LFPCoh(sig2(out.fast,:),sig1(out.fast,:),tapers,-500,[-500 2500], 1000, .01, [0 100],0,4,.05,0,2,1,ClusShuffOpts);

%without shuffling (pad == 4) & no tests
[coh.in.fast,f,tout,Sx.in.fast,Sy.in.fast,Pcoh.in.fast,PSx.in.fast,PSy.in.fast] = Spk_LFPCoh(sig2(in.fast,:),sig1(in.fast,:),tapers,-500,[-500 2500], 1000, .01, [0 100],0,4,.05,0,2,1);
[coh.out.fast,f,tout,Sx.out.fast,Sy.out.fast,Pcoh.out.fast,PSx.out.fast,PSy.out.fast] = Spk_LFPCoh(sig2(out.fast,:),sig1(out.fast,:),tapers,-500,[-500 2500], 1000, .01, [0 100],0,4,.05,0,2,1);
...
%with shuffling (pad = 0) & between condition tests
[~,~,~,~,~,~,~,~,~,~,~,between_cond_shuff.slow,~,~] = Spk_LFPCoh(sig2(alltr,:),sig1(alltr,:),tapers,-500,[-500 2500], 1000, .01, [0 100],0,4,.05,0,2,1,ClusShuffOpts);
clear alltr
ClusShuffOpts.TrType = [];

%with shuffling (pad = 0) & vsBaseline test
ClusShuffOpts.TestType = 1;
[~,~,~,~,~,~,~,~,~,~,~,within_cond_shuff.in.slow] = Spk_LFPCoh(sig2(in.slow,:),sig1(in.slow,:),tapers,-500,[-500 2500], 1000, .01, [0 100],0,4,.05,0,2,1,ClusShuffOpts);
[~,~,~,~,~,~,~,~,~,~,~,within_cond_shuff.out.slow] = Spk_LFPCoh(sig2(out.slow,:),sig1(out.slow,:),tapers,-500,[-500 2500], 1000, .01, [0 100],0,4,.05,0,2,1,ClusShuffOpts);

%without shuffling (pad == 4) & no tests
[coh.in.slow,f,tout,Sx.in.slow,Sy.in.slow,Pcoh.in.slow,PSx.in.slow,PSy.in.slow] = Spk_LFPCoh(sig2(in.slow,:),sig1(in.slow,:),tapers,-500,[-500 2500], 1000, .01, [0 100],0,4,.05,0,2,1);
[coh.out.slow,f,tout,Sx.out.slow,Sy.out.slow,Pcoh.out.slow,PSx.out.slow,PSy.out.slow] = Spk_LFPCoh(sig2(out.slow,:),sig1(out.slow,:),tapers,-500,[-500 2500], 1000, .01, [0 100],0,4,.05,0,2,1);
...
%with shuffling (pad = 0) & between condition tests
[~,~,~,~,~,~,~,~,~,~,~,between_cond_shuff.fast_slow,~,~] = Spk_LFPCoh(sig2(alltr,:),sig1(alltr,:),tapers,-500,[-500 2500], 1000, .01, [0 100],0,4,.05,0,2,1,ClusShuffOpts);
clear alltr
ClusShuffOpts.TrType = [];
...
if errskip == 0
    ...
    %with shuffling (pad = 0) & between condition tests
    [~,~,~,~,~,~,~,~,~,~,~,between_cond_shuff.err,~,~] = Spk_LFPCoh(sig2(alltr,:),sig1(alltr,:),tapers,-500,[-500 2500], 1000, .01, [0 100],0,4,.05,0,2,1,ClusShuffOpts);
    clear alltr
    ClusShuffOpts.TrType = [];
    
    %with shuffling (pad = 0) & vsBaseline test
    ClusShuffOpts.TestType = 1;
    [~,~,~,~,~,~,~,~,~,~,~,within_cond_shuff.in.err] = Spk_LFPCoh(sig2(in.err,:),sig1(in.err,:),tapers,-500,[-500 2500], 1000, .01, [0 100],0,4,.05,0,2,1,ClusShuffOpts);
    [~,~,~,~,~,~,~,~,~,~,~,within_cond_shuff.out.err] = Spk_LFPCoh(sig2(out.err,:),sig1(out.err,:),tapers,-500,[-500 2500], 1000, .01, [0 100],0,4,.05,0,2,1,ClusShuffOpts);
    
    %with shuffling (pad == 4) & no tests
    [coh.in.err,f,tout,Sx.in.err,Sy.in.err,Pcoh.in.err,PSx.in.err,PSy.in.err] = Spk_LFPCoh(sig2(in.err,:),sig1(in.err,:),tapers,-500,[-500 2500], 1000, .01, [0 100],0,4,.05,0,2,1);
    [coh.out.err,f,tout,Sx.out.err,Sy.out.err,Pcoh.out.err,PSx.out.err,PSy.out.err] = Spk_LFPCoh(sig2(out.err,:),sig1(out.err,:),tapers,-500,[-500 2500], 1000, .01, [0 100],0,4,.05,0,2,1);
    %=======================
    ...
    %with shuffling (pad = 0)  & between condition tests
    [~,~,~,~,~,~,~,~,~,~,~,between_cond_shuff.corr_err,~,~] = Spk_LFPCoh(sig2(alltr,:),sig1(alltr,:),tapers,-500,[-500 2500], 1000, .01, [0 100],0,4,.05,0,2,1,ClusShuffOpts);
    clear alltr
    ClusShuffOpts.TrType = [];
...
if errskip == 0
    for rep = 1:nReps
        ...
        [tempcoh.in.all_sub, f, tout, tempSx.in.all_sub, tempSy.in.all_sub, tempPcoh.in.all_sub, tempPSx.in.all_sub, tempPSy.in.all_sub] = Spk_LFPCoh(sig2(in.all_sub,:),sig1(in.all_sub,:),tapers,-500,[-500 2500],1000,.01,[0 100],0,4,.05,0,2,1);
        [tempcoh.out.all_sub, f, tout, tempSx.out.all_sub, tempSy.out.all_sub, tempPcoh.out.all_sub, tempPSx.out.all_sub, tempPSy.out.all_sub] = Spk_LFPCoh(sig2(out.all_sub,:),sig1(out.all_sub,:),tapers,-500,[-500 2500],1000,.01,[0 100],0,4,.05,0,2,1);
