...
function [] = pCOHERENCE_notnorm_SPKLFP_Hemi_NeurRF_isect_vamp_nooverlap(file_name,sig1_name,sig2_name)
...
if errskip == 0
    for rep = 1:nReps
        ...
        [tempcoh.in.all_sub, f, tout, tempSx.in.all_sub, tempSy.in.all_sub, tempPcoh.in.all_sub, tempPSx.in.all_sub, tempPSy.in.all_sub] = Spk_LFPCoh(sig2(in.all_sub,:),sig1(in.all_sub,:),tapers,-500,[-500 2500],1000,.01,[0 100],0,4,.05,0,2,0);
        ...
        [tempcoh.out.all_sub, f, tout, tempSx.out.all_sub, tempSy.out.all_sub, tempPcoh.out.all_sub, tempPSx.out.all_sub, tempPSy.out.all_sub] = Spk_LFPCoh(sig2(out.all_sub,:),sig1(out.all_sub,:),tapers,-500,[-500 2500],1000,.01,[0 100],0,4,.05,0,2,0);
