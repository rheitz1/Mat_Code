...
function [] = pCOH_SPKLFP_Tune_NeurRF_isect_vamp_overlap_shuff_uStim_widetape(file_name,sig1_name,sig2_name)
...
if shuffFlag == 1 & saveFlag == 1
    save(['//scratch/heitzrp/Output/Coherence/Uber_Tune_NeuronRF_intersection_shuff_uStim/overlap/widetape' file_name '_' ...
