...
cd /volumes/Dump2/Coherence/Uber_Tune_NeuronRF_intersection_shuff_allTL_corrected_thintapers/overlap/SameElectrode/

file_list = dir('*cS*.mat');
plotFlag = 0;
...
for sess = 1:length(file_list);
    ...
    Pcoh_all.in.all_sub(1:296,1:27,sess) = Pcoh.in.all_sub;
    Pcoh_all.in.all(1:296,1:27,sess) = Pcoh.in.all;
    Pcoh_all.in.ss2(1:296,1:27,sess) = Pcoh.in.ss2;
    Pcoh_all.in.ss4(1:296,1:27,sess) = Pcoh.in.ss4;
    Pcoh_all.in.ss8(1:296,1:27,sess) = Pcoh.in.ss8;
    Pcoh_all.in.fast(1:296,1:27,sess) = Pcoh.in.fast;
    Pcoh_all.in.slow(1:296,1:27,sess) = Pcoh.in.slow;
    Pcoh_all.in.err(1:296,1:27,sess) = Pcoh.in.err;
    
    Pcoh_all.out.all_sub(1:296,1:27,sess) = Pcoh.out.all_sub;
    Pcoh_all.out.all(1:296,1:27,sess) = Pcoh.out.all;
    Pcoh_all.out.ss2(1:296,1:27,sess) = Pcoh.out.ss2;
    Pcoh_all.out.ss4(1:296,1:27,sess) = Pcoh.out.ss4;
    Pcoh_all.out.ss8(1:296,1:27,sess) = Pcoh.out.ss8;
    Pcoh_all.out.fast(1:296,1:27,sess) = Pcoh.out.fast;
    Pcoh_all.out.slow(1:296,1:27,sess) = Pcoh.out.slow;
    Pcoh_all.out.err(1:296,1:27,sess) = Pcoh.out.err;
    
    
    %========================
    shuff_all.in.all.Pcoh(1:296,1:6,sess) = between_cond_shuff.all.TrType1.Pcoh;
    shuff_all.out.all.Pcoh(1:296,1:6,sess) = between_cond_shuff.all.TrType2.Pcoh;
    shuff_all.in_v_out.all.Pos(1:76,1:6,sess) = between_cond_shuff.all.Coh.Pos.SigClusAssign;
    shuff_all.in_v_out.all.Neg(1:76,1:6,sess) = between_cond_shuff.all.Coh.Neg.SigClusAssign;
...
%     
%     shuff_all.base_v_act.in.all.Pos(1:76,1:6,sess) = within_cond_shuff.in.all.Coh.Pos.SigClusAssign;
%     shuff_all.base_v_act.in.all.Neg(1:76,1:6,sess) = within_cond_shuff.in.all.Coh.Neg.SigClusAssign;
%     shuff_all.base_v_act.out.all.Pos(1:76,1:6,sess) = within_cond_shuff.out.all.Coh.Pos.SigClusAssign;
%     shuff_all.base_v_act.out.all.Neg(1:76,1:6,sess) = within_cond_shuff.out.all.Coh.Neg.SigClusAssign;
%     
...
%     shuff_all.base_v_act.out.all.Neg_TFCens(1:size(within_cond_shuff.out.all.Coh.Neg.SigClusTFCens,1),1:size(within_cond_shuff.out.all.Coh.Neg.SigClusTFCens,2),sess) = within_cond_shuff.out.all.Coh.Neg.SigClusTFCens;
    ...
    %=========================
    shuff_all.in.ss2.Pcoh(1:296,1:6,sess) = between_cond_shuff.ss2.TrType1.Pcoh;
    shuff_all.out.ss2.Pcoh(1:296,1:6,sess) = between_cond_shuff.ss2.TrType2.Pcoh;
    shuff_all.in_v_out.ss2.Pos(1:76,1:6,sess) = between_cond_shuff.ss2.Coh.Pos.SigClusAssign;
    shuff_all.in_v_out.ss2.Neg(1:76,1:6,sess) = between_cond_shuff.ss2.Coh.Neg.SigClusAssign;
...
%     
%     shuff_all.base_v_act.in.ss2.Pos(1:76,1:6,sess) = within_cond_shuff.in.ss2.Coh.Pos.SigClusAssign;
%     shuff_all.base_v_act.in.ss2.Neg(1:76,1:6,sess) = within_cond_shuff.in.ss2.Coh.Neg.SigClusAssign;
%     shuff_all.base_v_act.out.ss2.Pos(1:76,1:6,sess) = within_cond_shuff.out.ss2.Coh.Pos.SigClusAssign;
%     shuff_all.base_v_act.out.ss2.Neg(1:76,1:6,sess) = within_cond_shuff.out.ss2.Coh.Neg.SigClusAssign;
%     
...
%     shuff_all.base_v_act.out.ss2.Neg_TFCens(1:size(within_cond_shuff.out.ss2.Coh.Neg.SigClusTFCens,1),1:size(within_cond_shuff.out.ss2.Coh.Neg.SigClusTFCens,2),sess) = within_cond_shuff.out.ss2.Coh.Neg.SigClusTFCens;
    ...
    %==========================
    shuff_all.in.ss4.Pcoh(1:296,1:6,sess) = between_cond_shuff.ss4.TrType1.Pcoh;
    shuff_all.out.ss4.Pcoh(1:296,1:6,sess) = between_cond_shuff.ss4.TrType2.Pcoh;
    shuff_all.in_v_out.ss4.Pos(1:76,1:6,sess) = between_cond_shuff.ss4.Coh.Pos.SigClusAssign;
    shuff_all.in_v_out.ss4.Neg(1:76,1:6,sess) = between_cond_shuff.ss4.Coh.Neg.SigClusAssign;
...
%     
%     shuff_all.base_v_act.in.ss4.Pos(1:76,1:6,sess) = within_cond_shuff.in.ss4.Coh.Pos.SigClusAssign;
%     shuff_all.base_v_act.in.ss4.Neg(1:76,1:6,sess) = within_cond_shuff.in.ss4.Coh.Neg.SigClusAssign;
%     shuff_all.base_v_act.out.ss4.Pos(1:76,1:6,sess) = within_cond_shuff.out.ss4.Coh.Pos.SigClusAssign;
%     shuff_all.base_v_act.out.ss4.Neg(1:76,1:6,sess) = within_cond_shuff.out.ss4.Coh.Neg.SigClusAssign;
%     
...
%     shuff_all.base_v_act.out.ss4.Neg_TFCens(1:size(within_cond_shuff.out.ss4.Coh.Neg.SigClusTFCens,1),1:size(within_cond_shuff.out.ss4.Coh.Neg.SigClusTFCens,2),sess) = within_cond_shuff.out.ss4.Coh.Neg.SigClusTFCens;
    ...
    %===========================
    shuff_all.in.ss8.Pcoh(1:296,1:6,sess) = between_cond_shuff.ss8.TrType1.Pcoh;
    shuff_all.out.ss8.Pcoh(1:296,1:6,sess) = between_cond_shuff.ss8.TrType2.Pcoh;
    shuff_all.in_v_out.ss8.Pos(1:76,1:6,sess) = between_cond_shuff.ss8.Coh.Pos.SigClusAssign;
    shuff_all.in_v_out.ss8.Neg(1:76,1:6,sess) = between_cond_shuff.ss8.Coh.Neg.SigClusAssign;
...
%     
%     shuff_all.base_v_act.in.ss8.Pos(1:76,1:6,sess) = within_cond_shuff.in.ss8.Coh.Pos.SigClusAssign;
%     shuff_all.base_v_act.in.ss8.Neg(1:76,1:6,sess) = within_cond_shuff.in.ss8.Coh.Neg.SigClusAssign;
%     shuff_all.base_v_act.out.ss8.Pos(1:76,1:6,sess) = within_cond_shuff.out.ss8.Coh.Pos.SigClusAssign;
%     shuff_all.base_v_act.out.ss8.Neg(1:76,1:6,sess) = within_cond_shuff.out.ss8.Coh.Neg.SigClusAssign;
%     
...
%     shuff_all.base_v_act.out.ss8.Neg_TFCens(1:size(within_cond_shuff.out.ss8.Coh.Neg.SigClusTFCens,1),1:size(within_cond_shuff.out.ss8.Coh.Neg.SigClusTFCens,2),sess) = within_cond_shuff.out.ss8.Coh.Neg.SigClusTFCens;
    ...
    %===========================
    shuff_all.in.fast.Pcoh(1:296,1:6,sess) = between_cond_shuff.fast.TrType1.Pcoh;
    shuff_all.out.fast.Pcoh(1:296,1:6,sess) = between_cond_shuff.fast.TrType2.Pcoh;
    shuff_all.in_v_out.fast.Pos(1:76,1:6,sess) = between_cond_shuff.fast.Coh.Pos.SigClusAssign;
    shuff_all.in_v_out.fast.Neg(1:76,1:6,sess) = between_cond_shuff.fast.Coh.Neg.SigClusAssign;
...
%     shuff_all.base_v_act.in.fast.Pos(1:76,1:6,sess) = within_cond_shuff.in.fast.Coh.Pos.SigClusAssign;
%     shuff_all.base_v_act.in.fast.Neg(1:76,1:6,sess) = within_cond_shuff.in.fast.Coh.Neg.SigClusAssign;
%     shuff_all.base_v_act.out.fast.Pos(1:76,1:6,sess) = within_cond_shuff.out.fast.Coh.Pos.SigClusAssign;
%     shuff_all.base_v_act.out.fast.Neg(1:76,1:6,sess) = within_cond_shuff.out.fast.Coh.Neg.SigClusAssign;
%     
...
%     shuff_all.base_v_act.out.fast.Neg_TFCens(1:size(within_cond_shuff.out.fast.Coh.Neg.SigClusTFCens,1),1:size(within_cond_shuff.out.fast.Coh.Neg.SigClusTFCens,2),sess) = within_cond_shuff.out.fast.Coh.Neg.SigClusTFCens;
    ...
    %===========================
    shuff_all.in.slow.Pcoh(1:296,1:6,sess) = between_cond_shuff.slow.TrType1.Pcoh;
    shuff_all.out.slow.Pcoh(1:296,1:6,sess) = between_cond_shuff.slow.TrType2.Pcoh;
    shuff_all.in_v_out.slow.Pos(1:76,1:6,sess) = between_cond_shuff.slow.Coh.Pos.SigClusAssign;
    shuff_all.in_v_out.slow.Neg(1:76,1:6,sess) = between_cond_shuff.slow.Coh.Neg.SigClusAssign;
...
%     shuff_all.base_v_act.in.slow.Pos(1:76,1:6,sess) = within_cond_shuff.in.slow.Coh.Pos.SigClusAssign;
%     shuff_all.base_v_act.in.slow.Neg(1:76,1:6,sess) = within_cond_shuff.in.slow.Coh.Neg.SigClusAssign;
%     shuff_all.base_v_act.out.slow.Pos(1:76,1:6,sess) = within_cond_shuff.out.slow.Coh.Pos.SigClusAssign;
%     shuff_all.base_v_act.out.slow.Neg(1:76,1:6,sess) = within_cond_shuff.out.slow.Coh.Neg.SigClusAssign;
%     
...
%     shuff_all.base_v_act.out.slow.Neg_TFCens(1:size(within_cond_shuff.out.slow.Coh.Neg.SigClusTFCens,1),1:size(within_cond_shuff.out.slow.Coh.Neg.SigClusTFCens,2),sess) = within_cond_shuff.out.slow.Coh.Neg.SigClusTFCens;
    ...
    try
        shuff_all.in.err.Pcoh(1:296,1:6,sess) = between_cond_shuff.err.TrType1.Pcoh;
        shuff_all.out.err.Pcoh(1:296,1:6,sess) = between_cond_shuff.err.TrType2.Pcoh;
        shuff_all.in_v_out.err.Pos(1:76,1:6,sess) = between_cond_shuff.err.Coh.Pos.SigClusAssign;
        shuff_all.in_v_out.err.Neg(1:76,1:6,sess) = between_cond_shuff.err.Coh.Neg.SigClusAssign;
...
%         
%         shuff_all.base_v_act.in.err.Pos(1:76,1:6,sess) = within_cond_shuff.in.err.Coh.Pos.SigClusAssign;
%         shuff_all.base_v_act.in.err.Neg(1:76,1:6,sess) = within_cond_shuff.in.err.Coh.Neg.SigClusAssign;
%         shuff_all.base_v_act.out.err.Pos(1:76,1:6,sess) = within_cond_shuff.out.err.Coh.Pos.SigClusAssign;
%         shuff_all.base_v_act.out.err.Neg(1:76,1:6,sess) = within_cond_shuff.out.err.Coh.Neg.SigClusAssign;
%         
...
%         
        ...
        shuff_all.in_v_in.corr_err.Pos(1:76,1:6,sess) = between_cond_shuff.corr_err.Coh.Pos.SigClusAssign;
        shuff_all.in_v_in.corr_err.Neg(1:76,1:6,sess) = between_cond_shuff.corr_err.Coh.Neg.SigClusAssign;
        
    catch
        shuff_all.in.err.Pcoh(1:296,1:6,sess) = NaN;
        shuff_all.out.err.Pcoh(1:296,1:6,sess) = NaN;
        shuff_all.in_v_out.err.Pos(1:76,1:6,sess) = NaN;
        shuff_all.in_v_out.err.Neg(1:76,1:6,sess) = NaN;
        shuff_all.in_v_out.err.Pos_TFCens(1,1:2,sess) = NaN;
        shuff_all.in_v_out.err.Neg_TFCens(1,1:2,sess) = NaN;
        
        
%         shuff_all.base_v_act.in.err.Pos(1:76,1:6,sess) = NaN;
%         shuff_all.base_v_act.in.err.Neg(1:76,1:6,sess) = NaN;
%         shuff_all.base_v_act.out.err.Pos(1:76,1:6,sess) = NaN;
%         shuff_all.base_v_act.out.err.Neg(1:76,1:6,sess) = NaN;
...
%         shuff_all.base_v_act.out.err.Neg_TFCens(1,1:2,sess) = NaN;
        ...
        shuff_all.in_v_in.corr_err.Pos(1:76,1:6,sess) = NaN;
        shuff_all.in_v_in.corr_err.Neg(1:76,1:6,sess) = NaN;
        
    end
    
    
    shuff_all.in_v_in.fast_slow.Pos(1:76,1:6,sess) = between_cond_shuff.fast_slow.Coh.Pos.SigClusAssign;
    shuff_all.in_v_in.fast_slow.Neg(1:76,1:6,sess) = between_cond_shuff.fast_slow.Coh.Neg.SigClusAssign;
