...
cd /volumes/Dump2/Coherence/LFP-LFP/Uber_Tune_NeuronRF_intersection_shuff_allTL_corrected/overlap/
...
for sess = 1:length(file_list);
    ...
    Pcoh_all.in.all_sub(1:281,1:104,sess) = Pcoh.in.all_sub;
    Pcoh_all.in.all(1:281,1:104,sess) = Pcoh.in.all;
    Pcoh_all.in.ss2(1:281,1:104,sess) = Pcoh.in.ss2;
    Pcoh_all.in.ss4(1:281,1:104,sess) = Pcoh.in.ss4;
    Pcoh_all.in.ss8(1:281,1:104,sess) = Pcoh.in.ss8;
    Pcoh_all.in.fast(1:281,1:104,sess) = Pcoh.in.fast;
    Pcoh_all.in.slow(1:281,1:104,sess) = Pcoh.in.slow;
    Pcoh_all.in.err(1:281,1:104,sess) = Pcoh.in.err;
    
    Pcoh_all.out.all_sub(1:281,1:104,sess) = Pcoh.out.all_sub;
    Pcoh_all.out.all(1:281,1:104,sess) = Pcoh.out.all;
    Pcoh_all.out.ss2(1:281,1:104,sess) = Pcoh.out.ss2;
    Pcoh_all.out.ss4(1:281,1:104,sess) = Pcoh.out.ss4;
    Pcoh_all.out.ss8(1:281,1:104,sess) = Pcoh.out.ss8;
    Pcoh_all.out.fast(1:281,1:104,sess) = Pcoh.out.fast;
    Pcoh_all.out.slow(1:281,1:104,sess) = Pcoh.out.slow;
    Pcoh_all.out.err(1:281,1:104,sess) = Pcoh.out.err;
    ...
    %=========================
    shuff_all.in.ss2.Pcoh(1:281,1:21,sess) = between_cond_shuff.ss2.TrType1.Pcoh;
    shuff_all.out.ss2.Pcoh(1:281,1:21,sess) = between_cond_shuff.ss2.TrType2.Pcoh;
    ...
    %==========================
    shuff_all.in.ss4.Pcoh(1:281,1:21,sess) = between_cond_shuff.ss4.TrType1.Pcoh;
    shuff_all.out.ss4.Pcoh(1:281,1:21,sess) = between_cond_shuff.ss4.TrType2.Pcoh;
    ...
    %===========================
    shuff_all.in.ss8.Pcoh(1:281,1:21,sess) = between_cond_shuff.ss8.TrType1.Pcoh;
    shuff_all.out.ss8.Pcoh(1:281,1:21,sess) = between_cond_shuff.ss8.TrType2.Pcoh;
    ...
    %===========================
    shuff_all.in.fast.Pcoh(1:281,1:21,sess) = between_cond_shuff.fast.TrType1.Pcoh;
    shuff_all.out.fast.Pcoh(1:281,1:21,sess) = between_cond_shuff.fast.TrType2.Pcoh;
    ...
    %===========================
    shuff_all.in.slow.Pcoh(1:281,1:21,sess) = between_cond_shuff.slow.TrType1.Pcoh;
    shuff_all.out.slow.Pcoh(1:281,1:21,sess) = between_cond_shuff.slow.TrType2.Pcoh;
    ...
    try
        shuff_all.in.err.Pcoh(1:281,1:21,sess) = between_cond_shuff.err.TrType1.Pcoh;
        shuff_all.out.err.Pcoh(1:281,1:21,sess) = between_cond_shuff.err.TrType2.Pcoh;
        ...
        shuff_all.in.err.Pcoh(1:281,1:21,sess) = NaN;
        shuff_all.out.err.Pcoh(1:281,1:21,sess) = NaN;
    ...
    keep tout_shuff f_shuff normshuff_all shuff_all n tout f Pcoh_all coh_all TDT_all Sx_all Sy_all ...
