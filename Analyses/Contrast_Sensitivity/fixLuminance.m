...
elseif Target_(:,4) == 91 & Target_(:,12) == 10
    ...
    Target_(find(Target_(:,3) == 128),13) = NaN;
    Target_(find(Target_(:,3) == 137),13) = NaN;
    Target_(find(Target_(:,3) == 146),13) = .01;
    Target_(find(Target_(:,3) == 155),13) = .1;
    Target_(find(Target_(:,3) == 164),13) = .31;
    Target_(find(Target_(:,3) == 173),13) = .66;
    Target_(find(Target_(:,3) == 182),13) = 1.14;
    Target_(find(Target_(:,3) == 191),13) = 1.82;
...
elseif Target_(:,4) == 91 & Target_(:,12) == 9
    ...
    Target_(find(Target_(:,3) == 137),13) = NaN;
    Target_(find(Target_(:,3) == 146),13) = NaN;
    Target_(find(Target_(:,3) == 155),13) = .09;
    Target_(find(Target_(:,3) == 164),13) = .28;
    Target_(find(Target_(:,3) == 173),13) = .59;
    Target_(find(Target_(:,3) == 182),13) = 1.02;
    Target_(find(Target_(:,3) == 191),13) = 1.63;
