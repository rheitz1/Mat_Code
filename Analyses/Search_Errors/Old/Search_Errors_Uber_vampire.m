...
function [] = Search_Errors_Uber_vampire(file)
...
if saveFlag == 1
    if exist('TDT')
        eval(['save(' q MATdir,file,'_TDT.mat' qcq 'stats' qcq 'pos' qcq 'alpha' qcq 'n' qcq 'wf' qcq 'TDT' qcq 'RTs' qcq '-mat' q ')'])
    else
