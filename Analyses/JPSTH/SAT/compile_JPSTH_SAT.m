...
[filename unit1a unit1b] = textread('JPSTH_SAT_S.txt','%s %s %s');
...
for file = 1:length(filename)
    ...
    load(filename{file},unit{file,1},unit{file,2},'TrialStart_','saccLoc','Correct_','Target_','SRT','SAT_','Errors_','EyeX_','EyeY_','RFs','MFs','newfile','Hemi','FixTime_Jit_')
    filename{file}
