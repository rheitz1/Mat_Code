...
function [t_vector,above_furthest,above_far,above_close,main,below_close,below_far,below_furthest,thickdiagonal] = OffDiagonalAverage_vampire(JPSTC_matrix)
