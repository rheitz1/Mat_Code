...
for pair = size(pairings,1):-1:1
    ...
    %baseline correct
    JPSTC_correct = diag_baseline_correct(JPSTC_correct);
    JPSTC_correct_saccade = diag_baseline_correct(JPSTC_correct_saccade);
    shift_predictor = diag_baseline_correct(shift_predictor);
    ...
    if error_skip ~= 1
        ...
        %baseline correct
        JPSTC_errors = diag_baseline_correct(JPSTC_errors);
        JPSTC_errors_saccade = diag_baseline_correct(JPSTC_errors_saccade);
    ...
    if set_size_skip ~= 1
        ...
        %baseline correct
        JPSTC_correct_ss2 = diag_baseline_correct(JPSTC_correct_ss2);
        JPSTC_correct_ss2_saccade = diag_baseline_correct(JPSTC_correct_ss2_saccade);
        ...
        %baseline correct
        JPSTC_correct_ss4 = diag_baseline_correct(JPSTC_correct_ss4);
        JPSTC_correct_ss4_saccade = diag_baseline_correct(JPSTC_correct_ss4_saccade);
        ...
        %baseline correct
        JPSTC_correct_ss8 = diag_baseline_correct(JPSTC_correct_ss8);
        JPSTC_correct_ss8_saccade = diag_baseline_correct(JPSTC_correct_ss8_saccade);
    ...
    if homog_skip ~= 1
        ...
        %baseline correct
        JPSTC_correct_homo = diag_baseline_correct(JPSTC_correct_homo);
        JPSTC_correct_homo_saccade = diag_baseline_correct(JPSTC_correct_homo_saccade);
        ...
        %baseline correct
        JPSTC_correct_hete = diag_baseline_correct(JPSTC_correct_hete);
        JPSTC_correct_hete_saccade = diag_baseline_correct(JPSTC_correct_hete_saccade);
        ...
        disp('Missing Homogeneous or Heterogeneous Data...skipping')
    end
    ...
    if plotFlag == 1
        ...
        minval = min(minvals) - .05;
        maxval = max(maxvals) + .05;
        ...
        if pdfFlag == 1
            ...
            eval(['print -dpdf ',q,'//scratch/heitzrp/Output/correct_vs_shift/base_correct/PDF/',file,'_',[cell2mat(chanlist(pairings(pair,1))) cell2mat(chanlist(pairings(pair,2)))],'_correct_v_shift_base.pdf',q])
            %Print JPG
            eval(['print -djpeg100 ',q,'//scratch/heitzrp/Output/correct_vs_shift/base_correct/JPG/',file,'_',[cell2mat(chanlist(pairings(pair,1))) cell2mat(chanlist(pairings(pair,2)))],'_correct_v_shift_base.jpg',q])
        end
        ...
        if pdfFlag == 1
            %Print PDF
            eval(['print -dpdf ',q,'//scratch/heitzrp/Output/target_vs_saccade/base_correct/PDF/',file,'_',[cell2mat(chanlist(pairings(pair,1))) cell2mat(chanlist(pairings(pair,2)))],'_target_v_sacade_base.pdf',q])
            %Print JPG w/ 0% compression
            eval(['print -djpeg100 ',q,'//scratch/heitzrp/Output/target_vs_saccade/base_correct/JPG/',file,'_',[cell2mat(chanlist(pairings(pair,1))) cell2mat(chanlist(pairings(pair,2)))],'_target_v_sacade_base.jpg',q])
        end
        ...
        if error_skip ~= 1
            ...
            if pdfFlag == 1
                %Print PDF
                eval(['print -dpdf ',q,'//scratch/heitzrp/Output/correct_vs_errors/base_correct/PDF/',file,'_',[cell2mat(chanlist(pairings(pair,1))) cell2mat(chanlist(pairings(pair,2)))],'_correct_v_errors_targ_base.pdf',q])
                %Print JPG w/ 0% compression
                eval(['print -djpeg100 ',q,'//scratch/heitzrp/Output/correct_vs_errors/base_correct/JPG/',file,'_',[cell2mat(chanlist(pairings(pair,1))) cell2mat(chanlist(pairings(pair,2)))],'_correct_v_errors_targ_base.jpg',q])
            end
        ...
        if error_skip ~= 1
            ...
            if pdfFlag == 1
                %Print PDF
                eval(['print -dpdf ',q,'//scratch/heitzrp/Output/correct_vs_errors_saccade/base_correct/PDF/',file,'_',[cell2mat(chanlist(pairings(pair,1))) cell2mat(chanlist(pairings(pair,2)))],'_correct_v_errors_sacc_base.pdf',q])
                %Print JPG w/ 0% compression
                eval(['print -djpeg100 ',q,'//scratch/heitzrp/Output/correct_vs_errors_saccade/base_correct/JPG/',file,'_',[cell2mat(chanlist(pairings(pair,1))) cell2mat(chanlist(pairings(pair,2)))],'_correct_v_errors_sacc_base.jpg',q])
            end
        ...
        if set_size_skip ~= 1
            ...
            if pdfFlag == 1
                %Print PDF
                eval(['print -dpdf ',q,'//scratch/heitzrp/Output/set_size/base_correct/PDF/',file,'_',[cell2mat(chanlist(pairings(pair,1))) cell2mat(chanlist(pairings(pair,2)))],'_set_size_targ_base.pdf',q])
                %Print JPG w/ 0% compression
                eval(['print -djpeg100 ',q,'//scratch/heitzrp/Output/set_size/base_correct/JPG/',file,'_',[cell2mat(chanlist(pairings(pair,1))) cell2mat(chanlist(pairings(pair,2)))],'_set_size_targ_base.jpg',q])
            end
        ...
        if set_size_skip ~= 1
            ...
            minvals(6) = min(below_furthest_ss2_saccade);   maxvals(6) = max(below_furthest_ss4_saccade);
            ...
            if pdfFlag == 1
                %Print PDF
                eval(['print -dpdf ',q,'//scratch/heitzrp/Output/set_size_saccade/base_correct/PDF/',file,'_',[cell2mat(chanlist(pairings(pair,1))) cell2mat(chanlist(pairings(pair,2)))],'_set_size_sacc_base.pdf',q])
                %Print JPG w/ 0% compression
                eval(['print -djpeg100 ',q,'//scratch/heitzrp/Output/set_size_saccade/base_correct/JPG/',file,'_',[cell2mat(chanlist(pairings(pair,1))) cell2mat(chanlist(pairings(pair,2)))],'_set_size_sacc_base.jpg',q])
            end
        ...
        if homog_skip ~= 1
            ...
            if pdfFlag == 1
                %Print PDF
                eval(['print -dpdf ',q,'//scratch/heitzrp/Output/homog/base_correct/PDF/',file,'_',[cell2mat(chanlist(pairings(pair,1))) cell2mat(chanlist(pairings(pair,2)))],'_homog_targ_base.pdf',q])
                %Print JPG w/ 0% compression
                eval(['print -djpeg100 ',q,'//scratch/heitzrp/Output/homog/base_correct/JPG/',file,'_',[cell2mat(chanlist(pairings(pair,1))) cell2mat(chanlist(pairings(pair,2)))],'_homog_targ_base.jpg',q])
            end
        ...
        if homog_skip ~= 1
            ...
            if pdfFlag == 1
                %Print PDF
                eval(['print -dpdf ',q,'//scratch/heitzrp/Output/homog_saccade/base_correct/PDF/',file,'_',[cell2mat(chanlist(pairings(pair,1))) cell2mat(chanlist(pairings(pair,2)))],'_homog_sacc_base.pdf',q])
                %Print JPG w/ 0% compression
                eval(['print -djpeg100 ',q,'//scratch/heitzrp/Output/homog_saccade/base_correct/JPG/',file,'_',[cell2mat(chanlist(pairings(pair,1))) cell2mat(chanlist(pairings(pair,2)))],'_homog_sacc_base.jpg',q])
            end
