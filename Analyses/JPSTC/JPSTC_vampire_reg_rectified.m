...
%             end
    ...
    if plotFlag == 1
        ...
        if pdfFlag == 1
            ...
            %eval(['print -dpdf ',q,'//scratch/heitzrp/Output/correct_vs_shift/reg/PDF/',file,'_',[cell2mat(chanlist(pairings(pair,1))) cell2mat(chanlist(pairings(pair,2)))],'_correct_v_shift_regRectified.pdf',q])
            %Print JPG
            eval(['print -djpeg100 ',q,'//scratch/heitzrp/Output/correct_vs_shift/reg/JPG/',file,'_',[cell2mat(chanlist(pairings(pair,1))) cell2mat(chanlist(pairings(pair,2)))],'_correct_v_shift_regRectified.jpg',q])
        end
