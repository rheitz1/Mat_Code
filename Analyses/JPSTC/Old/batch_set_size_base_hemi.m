...
batch_list = dir('/volumes/dump/final/JPSTC_matrices/base_correct/LFP-LFP/BetweenHemi/*.mat');
...
% W I T H I N   H E M I
batch_list = dir('/volumes/dump/final/JPSTC_matrices/base_correct/LFP-LFP/WithinHemi/*.mat');
above_close_ss2_all(1:length(batch_list),1:251) = NaN;
above_close_ss4_all(1:length(batch_list),1:251) = NaN;
above_close_ss8_all(1:length(batch_list),1:251) = NaN;
