...
%cd /Volumes/Dump2/Coherence/SPK-SPK/Baseline/SAT/RawDat/
cd ~/desktop/SPK-SPK_SAT_New/
file_list = dir('S*.mat');
...
for sess = 1:length(file_list);
    ...
    %
    %=========================
    issig1_all.h(sess,1) = issig1.h;
    issig1_all.dir(sess,1) = issig1.dir;
    issig2_all.h(sess,1) = issig2.h;
    issig2_all.dir(sess,1) = issig2.dir;
    ...
    wf_all_targ.SPK1.slow(sess,1:size(wf_targ.SPK1.slow_all,1)) = wf_targ.SPK1.slow_all;
    wf_all_targ.SPK1.fast(sess,1:size(wf_targ.SPK1.fast_all,1)) = wf_targ.SPK1.fast_all;
    wf_all_targ.SPK2.slow(sess,1:size(wf_targ.SPK2.slow_all,1)) = wf_targ.SPK2.slow_all;
    wf_all_targ.SPK2.fast(sess,1:size(wf_targ.SPK2.fast_all,1)) = wf_targ.SPK2.fast_all;
    
    wf_all_resp.SPK1.slow(sess,1:size(wf_resp.SPK1.slow_all,1)) = wf_resp.SPK1.slow_all;
    wf_all_resp.SPK1.fast(sess,1:size(wf_resp.SPK1.fast_all,1)) = wf_resp.SPK1.fast_all;
    wf_all_resp.SPK2.slow(sess,1:size(wf_resp.SPK2.slow_all,1)) = wf_resp.SPK2.slow_all;
    wf_all_resp.SPK2.fast(sess,1:size(wf_resp.SPK2.fast_all,1)) = wf_resp.SPK2.fast_all;
    
    wf_all_fix.SPK1.slow(sess,1:size(wf_fix.SPK1.slow_all,1)) = wf_fix.SPK1.slow_all;
    wf_all_fix.SPK1.fast(sess,1:size(wf_fix.SPK1.fast_all,1)) = wf_fix.SPK1.fast_all;
    wf_all_fix.SPK2.slow(sess,1:size(wf_fix.SPK2.slow_all,1)) = wf_fix.SPK2.slow_all;
    wf_all_fix.SPK2.fast(sess,1:size(wf_fix.SPK2.fast_all,1)) = wf_fix.SPK2.fast_all;
