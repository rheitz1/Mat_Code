...
[filename unit] = textread('SAT_LFP_S.txt','%s %s');


for file = 1:length(filename)
    
    load(filename{file},unit{file},'Hemi','saccLoc','Correct_','Target_','SRT','SAT_','Errors_','EyeX_','EyeY_','RFs','MFs','newfile')
    filename{file}
    ...
    %response align
    sig = response_align(sig,SRT,[-400 200]);
    
    %baseline_correct
    sig_bc = baseline_correct(sig,[1 50]);
...
%     allROC.fast_correct_made_dead_withCleared(file,1:1001) = ROC.fast_correct_made_dead_withCleared;
    ...
    if JackKnife_TDT_test
        [TDT.jack_slow_vs_fast(file,1:2) t_obt(file,1) p(file,1)] = getJackKnife_TDT(-400:200,SDF(in.slow_correct_made_dead_RF,:),SDF(out.slow_correct_made_dead_RF,:),SDF(in.fast_correct_made_dead_withCleared_RF,:),SDF(out.fast_correct_made_dead_withCleared_RF,:));
    end
...
fon
subplot(2,2,1)
plot(-400:200,nanmean(allwf_targ.in.slow_correct_made_dead),'r',-400:200,nanmean(allwf_targ.out.slow_correct_made_dead),'--r', ...
    -400:200,nanmean(allwf_targ.in.med_correct),'k',-400:200,nanmean(allwf_targ.out.med_correct),'--k', ...
    -400:200,nanmean(allwf_targ.in.fast_correct_made_dead_withCleared),'g',-400:200,nanmean(allwf_targ.out.fast_correct_made_dead_withCleared),'--g')
xlim([-400 200])
...
subplot(2,2,2)
plot(-400:200,nanmean(allwf_targ.in.slow_errors_made_dead),'r',-400:200,nanmean(allwf_targ.out.slow_errors_made_dead),'--r', ...
    -400:200,nanmean(allwf_targ.in.med_errors),'k',-400:200,nanmean(allwf_targ.out.med_errors),'--k', ...
    -400:200,nanmean(allwf_targ.in.fast_errors_made_dead_withCleared),'g',-400:200,nanmean(allwf_targ.out.fast_errors_made_dead_withCleared),'--g')
xlim([-400 200])
...
subplot(2,2,3)
plot(-400:200,nanmean(allwf_targ.in.slow_correct_missed_dead),'r',-400:200,nanmean(allwf_targ.out.slow_correct_missed_dead),'--r', ...
    -400:200,nanmean(allwf_targ.in.med_correct),'k',-400:200,nanmean(allwf_targ.out.med_correct),'--k', ...
    -400:200,nanmean(allwf_targ.in.fast_correct_missed_dead_withCleared),'g',-400:200,nanmean(allwf_targ.out.fast_correct_missed_dead_withCleared),'--g')
xlim([-400 200])
...
subplot(2,2,4)
plot(-400:200,nanmean(allwf_targ.in.slow_errors_missed_dead),'r',-400:200,nanmean(allwf_targ.out.slow_errors_missed_dead),'--r', ...
    -400:200,nanmean(allwf_targ.in.med_errors),'k',-400:200,nanmean(allwf_targ.out.med_errors),'--k', ...
    -400:200,nanmean(allwf_targ.in.fast_errors_missed_dead_withCleared),'g',-400:200,nanmean(allwf_targ.out.fast_errors_missed_dead_withCleared),'--g')
xlim([-400 200])
...
fon
subplot(2,2,1)
plot(-400:200,nanmean(allwf_targ.in.slow_correct_made_dead),'r',-400:200,nanmean(allwf_targ.out.slow_correct_made_dead),'--r', 'linewidth',2)
hold on
plot(-400:200,nanmean(allwf_targ.in.slow_correct_missed_dead),'r',-400:200,nanmean(allwf_targ.out.slow_correct_missed_dead),'--r')
xlim([-100 500])
title('SLOW CORRECT')
...
subplot(2,2,2)
plot(-400:200,nanmean(allwf_targ.in.fast_correct_made_dead_withCleared),'g',-400:200,nanmean(allwf_targ.out.fast_correct_made_dead_withCleared),'--g', 'linewidth',2)
hold on
plot(-400:200,nanmean(allwf_targ.in.fast_correct_missed_dead_withCleared),'g',-400:200,nanmean(allwf_targ.out.fast_correct_missed_dead_withCleared),'--g')
xlim([-100 500])
title('FAST CORRECT')
set(gca,'xminortick','on')
box off
...
subplot(2,2,3)
plot(-400:200,nanmean(allwf_targ.in.slow_errors_made_dead),'r',-400:200,nanmean(allwf_targ.out.slow_errors_made_dead),'--r', 'linewidth',2)
hold on
plot(-400:200,nanmean(allwf_targ.in.slow_errors_missed_dead),'r',-400:200,nanmean(allwf_targ.out.slow_errors_missed_dead),'--r')
xlim([-100 500])
title('SLOW ERRORS')
...
subplot(2,2,4)
plot(-400:200,nanmean(allwf_targ.in.fast_errors_made_dead_withCleared),'g',-400:200,nanmean(allwf_targ.out.fast_errors_made_dead_withCleared),'--g', 'linewidth',2)
hold on
plot(-400:200,nanmean(allwf_targ.in.fast_errors_missed_dead_withCleared),'g',-400:200,nanmean(allwf_targ.out.fast_errors_missed_dead_withCleared),'--g')
xlim([-100 500])
title('FAST ERRORS')
set(gca,'xminortick','on')
box off
...
figure
subplot(2,2,1)
plot(-400:200,nanmean(allwf_targ.in.slow_correct_made_dead_binSLOW),'r', ...
    -400:200,nanmean(allwf_targ.in.slow_correct_made_dead_binMED),'k', ...
    -400:200,nanmean(allwf_targ.in.slow_correct_made_dead_binFAST),'g')
...
plot(-400:200,nanmean(allwf_targ.in.med_correct_binSLOW),'r', ...
    -400:200,nanmean(allwf_targ.in.med_correct_binMED),'k', ...
    -400:200,nanmean(allwf_targ.in.med_correct_binFAST),'g')
title('med CONDITION')
xlim([-100 500])
set(gca,'xminortick','on')
box off
...
subplot(2,2,3)
plot(-400:200,nanmean(allwf_targ.in.fast_correct_made_dead_withCleared_binSLOW),'r', ...
    -400:200,nanmean(allwf_targ.in.fast_correct_made_dead_withCleared_binMED),'k', ...
    -400:200,nanmean(allwf_targ.in.fast_correct_made_dead_withCleared_binFAST),'g')
...
subplot(2,2,1)
plot(-400:200,nanmean(allwf_targ.in.slow_correct_made_dead_binSLOW),'r', ...
    -400:200,nanmean(allwf_targ.in.med_correct_binSLOW),'k', ...
    -400:200,nanmean(allwf_targ.in.fast_correct_made_dead_withCleared_binSLOW),'g')
title('SLOW BINS')
xlim([-100 500])
set(gca,'xminortick','on')
box off
...
plot(-400:200,nanmean(allwf_targ.in.slow_correct_made_dead_binMED),'r', ...
    -400:200,nanmean(allwf_targ.in.med_correct_binMED),'k', ...
    -400:200,nanmean(allwf_targ.in.fast_correct_made_dead_withCleared_binMED),'g')
title('med BINS')
xlim([-100 500])
set(gca,'xminortick','on')
box off
...
subplot(2,2,3)
plot(-400:200,nanmean(allwf_targ.in.slow_correct_made_dead_binFAST),'r', ...
    -400:200,nanmean(allwf_targ.in.med_correct_binFAST),'k', ...
    -400:200,nanmean(allwf_targ.in.fast_correct_made_dead_withCleared_binFAST),'g')
title('fast BINS')
xlim([-100 500])
equate_y
...
figure
subplot(1,2,1)
plot(-400:200,nanmean(allwf_targ.in.slow_correct_made_dead),'r', ...
    -400:200,nanmean(allwf_targ.in.med_correct_match_slow),'k')
xlim([-100 900])
...
subplot(1,2,2)
plot(-400:200,nanmean(allwf_targ.in.fast_correct_made_dead_withCleared),'g', ...
    -400:200,nanmean(allwf_targ.in.med_correct_match_fast),'k')
xlim([-100 900])
...
figure
subplot(2,2,1)
plot(-400:200,nanmean(allwf_targ.in.med_correct_match_med(haveMed,:)),'k', ...
    -400:200,nanmean(allwf_targ.in.slow_correct_match_med(haveMed,:)),'r', ...
    -400:200,nanmean(allwf_targ.in.fast_correct_match_med(haveMed,:)),'g', ...
    -400:200,nanmean(allwf_targ.out.med_correct_match_med(haveMed,:)),'--k', ...
    -400:200,nanmean(allwf_targ.out.slow_correct_match_med(haveMed,:)),'--r', ...
    -400:200,nanmean(allwf_targ.out.fast_correct_match_med(haveMed,:)),'--g')
xlim([-400 200])
ylim([.3 1.1])
set(gca,'xminortick','on')
box off