...
targTime = find(tout_targ>=sigOnly_timerange(1) & tout_targ<=sigOnly_timerange(2));

% targFreq_shuff = find(f_shuff>=sigOnly_freqrange(1) & f_shuff<=sigOnly_freqrange(2));
% targTime_shuff = find(tout_targ_shuff>=sigOnly_timerange(1) & tout_targ_shuff<=sigOnly_timerange(2));

d = abs(coh_all_targ.fast) - abs(coh_all_targ.slow);
d = nanmean(d,3);

sl = nanmean(abs(coh_all_targ.slow(:,targFreq,:)),2);
sl = squeeze(sl);

fs = nanmean(abs(coh_all_targ.fast(:,targFreq,:)),2);
fs = squeeze(fs);
...
% 
% sl_sigpos = coh_all_targ.slow(:,:,pos);
...
% 
% fs_sigpos = coh_all_targ.fast(:,:,pos);
...
% 
% sl_signeg = coh_all_targ.slow(:,:,neg);
...
% 
% fs_signeg = coh_all_targ.fast(:,:,neg);
...
% 
% sl_signot = coh_all_targ.slow(:,:,not);
...
% 
% fs_signot = coh_all_targ.fast(:,:,not);
...
sl_5 = nanmean(abs(coh_all_targ.slow(:,targFreq5,:)),2);
sl_5 = (nanmean(sl_5(targTime,:),1));

sl_10 = nanmean(abs(coh_all_targ.slow(:,targFreq10,:)),2);
sl_10 = (nanmean(sl_10(targTime,:),1));

sl_15 = nanmean(abs(coh_all_targ.slow(:,targFreq15,:)),2);
sl_15 = (nanmean(sl_15(targTime,:),1));

sl_20 = nanmean(abs(coh_all_targ.slow(:,targFreq20,:)),2);
sl_20 = (nanmean(sl_20(targTime,:),1));

sl_25 = nanmean(abs(coh_all_targ.slow(:,targFreq25,:)),2);
sl_25 = (nanmean(sl_25(targTime,:),1));

sl_30 = nanmean(abs(coh_all_targ.slow(:,targFreq30,:)),2);
sl_30 = (nanmean(sl_30(targTime,:),1));

sl_35 = nanmean(abs(coh_all_targ.slow(:,targFreq35,:)),2);
sl_35 = (nanmean(sl_35(targTime,:),1));

sl_40 = nanmean(abs(coh_all_targ.slow(:,targFreq40,:)),2);
sl_40 = (nanmean(sl_40(targTime,:),1));

sl_45 = nanmean(abs(coh_all_targ.slow(:,targFreq45,:)),2);
sl_45 = (nanmean(sl_45(targTime,:),1));

sl_50 = nanmean(abs(coh_all_targ.slow(:,targFreq50,:)),2);
sl_50 = (nanmean(sl_50(targTime,:),1));

sl_55 = nanmean(abs(coh_all_targ.slow(:,targFreq55,:)),2);
sl_55 = (nanmean(sl_55(targTime,:),1));

sl_60 = nanmean(abs(coh_all_targ.slow(:,targFreq60,:)),2);
sl_60 = (nanmean(sl_60(targTime,:),1));

sl_65 = nanmean(abs(coh_all_targ.slow(:,targFreq65,:)),2);
sl_65 = (nanmean(sl_65(targTime,:),1));

sl_70 = nanmean(abs(coh_all_targ.slow(:,targFreq70,:)),2);
sl_70 = (nanmean(sl_70(targTime,:),1));

sl_75 = nanmean(abs(coh_all_targ.slow(:,targFreq75,:)),2);
sl_75 = (nanmean(sl_75(targTime,:),1));

sl_80 = nanmean(abs(coh_all_targ.slow(:,targFreq80,:)),2);
sl_80 = (nanmean(sl_80(targTime,:),1));


fs_5 = nanmean(abs(coh_all_targ.fast(:,targFreq5,:)),2);
fs_5 = (nanmean(fs_5(targTime,:),1));
 
fs_10 = nanmean(abs(coh_all_targ.fast(:,targFreq10,:)),2);
fs_10 = (nanmean(fs_10(targTime,:),1));
 
fs_15 = nanmean(abs(coh_all_targ.fast(:,targFreq15,:)),2);
fs_15 = (nanmean(fs_15(targTime,:),1));
 
fs_20 = nanmean(abs(coh_all_targ.fast(:,targFreq20,:)),2);
fs_20 = (nanmean(fs_20(targTime,:),1));
 
fs_25 = nanmean(abs(coh_all_targ.fast(:,targFreq25,:)),2);
fs_25 = (nanmean(fs_25(targTime,:),1));
 
fs_30 = nanmean(abs(coh_all_targ.fast(:,targFreq30,:)),2);
fs_30 = (nanmean(fs_30(targTime,:),1));
 
fs_35 = nanmean(abs(coh_all_targ.fast(:,targFreq35,:)),2);
fs_35 = (nanmean(fs_35(targTime,:),1));
 
fs_40 = nanmean(abs(coh_all_targ.fast(:,targFreq40,:)),2);
fs_40 = (nanmean(fs_40(targTime,:),1));
 
fs_45 = nanmean(abs(coh_all_targ.fast(:,targFreq45,:)),2);
fs_45 = (nanmean(fs_45(targTime,:),1));
 
fs_50 = nanmean(abs(coh_all_targ.fast(:,targFreq50,:)),2);
fs_50 = (nanmean(fs_50(targTime,:),1));
 
fs_55 = nanmean(abs(coh_all_targ.fast(:,targFreq55,:)),2);
fs_55 = (nanmean(fs_55(targTime,:),1));
 
fs_60 = nanmean(abs(coh_all_targ.fast(:,targFreq60,:)),2);
fs_60 = (nanmean(fs_60(targTime,:),1));
 
fs_65 = nanmean(abs(coh_all_targ.fast(:,targFreq65,:)),2);
fs_65 = (nanmean(fs_65(targTime,:),1));
 
fs_70 = nanmean(abs(coh_all_targ.fast(:,targFreq70,:)),2);
fs_70 = (nanmean(fs_70(targTime,:),1));
 
fs_75 = nanmean(abs(coh_all_targ.fast(:,targFreq75,:)),2);
fs_75 = (nanmean(fs_75(targTime,:),1));
 
fs_80 = nanmean(abs(coh_all_targ.fast(:,targFreq80,:)),2);
