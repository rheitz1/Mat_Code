...
function [Fano,real_time,CV2] = getFano_fix_acq(Spike,binwidth,stepsz,window,trls,plotFlag)

parallelCheck

%variables we'll need
Target_ = evalin('caller','Target_');
FixAcqTime_ = evalin('caller','FixAcqTime_');
...
Spike = Spike - repmat(  (Target_(1,1) + FixAcqTime_)  ,1,size(Spike,2));
