% TRIM_TIME_STAMPS makes all time_stamps outside of time_window = NaN
...
function [timestamps] = trim_time_stamps(timestamps, time_window, binwidth)

	% set all timestamps outside of time window = NaN 
	timestamps(timestamps<=time_window(1) | timestamps>=time_window(2)) = NaN;
