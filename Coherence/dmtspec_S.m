...
if PSDScaleFlag
    ...
    %note: dividing by nt only works to scale properly for a rectangular taper...
    %Xk=abs(Xk)/nt;  %you want to do this before squaring Xk... %note nt is number of time samps, not number of trials...
